...
public class DictionaryControllerApiTest {
    ...
    public void getColumnValuesTest() throws Exception {
        DictionaryColumnValueSearchDTO body = null;
        UUID dictionaryUuid = null;
        UUID columnUuid = null;
        UUID mailbox = null;
        Integer offset = null;
        Integer limit = null;
        PageDTODictionaryColumnValueResponseDTO response = api.getColumnValues(body, dictionaryUuid, columnUuid, mailbox, offset, limit);
