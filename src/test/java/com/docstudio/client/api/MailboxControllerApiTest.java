...
public class MailboxControllerApiTest {
    ...
    public void deleteMailboxTest() throws Exception {
        ...
        UUID mailbox = null;
        UUID moveEntitiesToMailbox = null;
        api.deleteMailbox(checkMessage, mailbox, moveEntitiesToMailbox);
     ...
     */
    @Test
    public void getAutoDelegationTest() throws Exception {
        UUID mailboxUuid = null;
     ...
     */
    @Test
    public void leaveMailboxTest() throws Exception {
        UUID mailboxUuid = null;
        api.leaveMailbox(mailboxUuid);
     ...
     */
    @Test
    public void searchMailboxesAsParticipantsTest() throws Exception {
        String q = null;
        String type = null;
        UUID mailbox = null;
     ...
     */
    @Test
    public void updateAutoDelegationTest() throws Exception {
        MailboxDelegationDTO body = null;
        UUID mailboxUuid = null;
        api.updateAutoDelegation(body, mailboxUuid);
