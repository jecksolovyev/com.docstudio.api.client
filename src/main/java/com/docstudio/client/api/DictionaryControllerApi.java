...
public class DictionaryControllerApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getColumnValuesCall(DictionaryColumnValueSearchDTO body, UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getColumnValuesValidateBeforeCall(DictionaryColumnValueSearchDTO body, UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        com.squareup.okhttp.Call call = getColumnValuesCall(body, dictionaryUuid, columnUuid, mailbox, offset, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageDTODictionaryColumnValueResponseDTO getColumnValues(DictionaryColumnValueSearchDTO body, UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit) throws ApiException {
        ApiResponse<PageDTODictionaryColumnValueResponseDTO> resp = getColumnValuesWithHttpInfo(body, dictionaryUuid, columnUuid, mailbox, offset, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageDTODictionaryColumnValueResponseDTO> getColumnValuesWithHttpInfo(DictionaryColumnValueSearchDTO body, UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = getColumnValuesValidateBeforeCall(body, dictionaryUuid, columnUuid, mailbox, offset, limit, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getColumnValuesAsync(DictionaryColumnValueSearchDTO body, UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit, final ApiCallback<PageDTODictionaryColumnValueResponseDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getColumnValuesValidateBeforeCall(body, dictionaryUuid, columnUuid, mailbox, offset, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageDTODictionaryColumnValueResponseDTO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
