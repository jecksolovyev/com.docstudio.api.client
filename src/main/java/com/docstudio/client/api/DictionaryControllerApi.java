...
public class DictionaryControllerApi {
     ...
     */
    public okhttp3.Call archive1Call(UUID dictionaryUuid, UUID mailbox, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call archive1ValidateBeforeCall(UUID dictionaryUuid, UUID mailbox, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void archive1(UUID dictionaryUuid, UUID mailbox) throws ApiException {
     ...
     */
    public ApiResponse<Void> archive1WithHttpInfo(UUID dictionaryUuid, UUID mailbox) throws ApiException {
     ...
     */
    public okhttp3.Call archive1Async(UUID dictionaryUuid, UUID mailbox, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call deleteColumnCall(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteColumnValidateBeforeCall(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dictionaryUuid' is set
        if (dictionaryUuid == null) {
     ...
     */
    public SingleUuidDTO deleteColumn(UUID dictionaryUuid, UUID columnUuid, UUID mailbox) throws ApiException {
     ...
     */
    public ApiResponse<SingleUuidDTO> deleteColumnWithHttpInfo(UUID dictionaryUuid, UUID columnUuid, UUID mailbox) throws ApiException {
     ...
     */
    public okhttp3.Call deleteColumnAsync(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, final ApiCallback<SingleUuidDTO> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateColumn1Call(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, DictionaryColumnRequestDTO dictionaryColumnRequestDTO, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateColumn1ValidateBeforeCall(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, DictionaryColumnRequestDTO dictionaryColumnRequestDTO, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dictionaryUuid' is set
        if (dictionaryUuid == null) {
     ...
     */
    public DictionaryColumnResponseDTO updateColumn1(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, DictionaryColumnRequestDTO dictionaryColumnRequestDTO) throws ApiException {
     ...
     */
    public ApiResponse<DictionaryColumnResponseDTO> updateColumn1WithHttpInfo(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, DictionaryColumnRequestDTO dictionaryColumnRequestDTO) throws ApiException {
     ...
     */
    public okhttp3.Call updateColumn1Async(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, DictionaryColumnRequestDTO dictionaryColumnRequestDTO, final ApiCallback<DictionaryColumnResponseDTO> _callback) throws ApiException {
