...
public class TemplateControllerApi {
     ...
     */
    public okhttp3.Call createCall(UUID mailbox, TemplateCreateDTO templateCreateDTO, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createValidateBeforeCall(UUID mailbox, TemplateCreateDTO templateCreateDTO, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'mailbox' is set
        if (mailbox == null) {
        ...
        if (templateCreateDTO == null) {
            throw new ApiException("Missing the required parameter 'templateCreateDTO' when calling create(Async)");
        }

        return createCall(mailbox, templateCreateDTO, _callback);
     ...
     */
    public FullTemplateResponseDTO create(UUID mailbox, TemplateCreateDTO templateCreateDTO) throws ApiException {
        ApiResponse<FullTemplateResponseDTO> localVarResp = createWithHttpInfo(mailbox, templateCreateDTO);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FullTemplateResponseDTO> createWithHttpInfo(UUID mailbox, TemplateCreateDTO templateCreateDTO) throws ApiException {
        okhttp3.Call localVarCall = createValidateBeforeCall(mailbox, templateCreateDTO, null);
        Type localVarReturnType = new TypeToken<FullTemplateResponseDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call createAsync(UUID mailbox, TemplateCreateDTO templateCreateDTO, final ApiCallback<FullTemplateResponseDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = createValidateBeforeCall(mailbox, templateCreateDTO, _callback);
        Type localVarReturnType = new TypeToken<FullTemplateResponseDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public List<byte[]> downloadTemplateImage(UUID uuid, UUID imageUuid, UUID envelopeUuid, UUID mailbox) throws ApiException {
        ApiResponse<List<byte[]>> localVarResp = downloadTemplateImageWithHttpInfo(uuid, imageUuid, envelopeUuid, mailbox);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<byte[]>> downloadTemplateImageWithHttpInfo(UUID uuid, UUID imageUuid, UUID envelopeUuid, UUID mailbox) throws ApiException {
     ...
     */
    public okhttp3.Call downloadTemplateImageAsync(UUID uuid, UUID imageUuid, UUID envelopeUuid, UUID mailbox, final ApiCallback<List<byte[]>> _callback) throws ApiException {
     ...
     */
    public List<byte[]> downloadTemplatePdf(UUID uuid, UUID pdfUuid, UUID envelopeUuid, Boolean clearFields, UUID mailbox) throws ApiException {
        ApiResponse<List<byte[]>> localVarResp = downloadTemplatePdfWithHttpInfo(uuid, pdfUuid, envelopeUuid, clearFields, mailbox);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<byte[]>> downloadTemplatePdfWithHttpInfo(UUID uuid, UUID pdfUuid, UUID envelopeUuid, Boolean clearFields, UUID mailbox) throws ApiException {
     ...
     */
    public okhttp3.Call downloadTemplatePdfAsync(UUID uuid, UUID pdfUuid, UUID envelopeUuid, Boolean clearFields, UUID mailbox, final ApiCallback<List<byte[]>> _callback) throws ApiException {
