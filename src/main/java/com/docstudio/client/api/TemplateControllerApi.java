...
public class TemplateControllerApi {
     ...
     */
    public okhttp3.Call getTemplateByUuidCall(UUID uuid, UUID mailbox, UUID templateVersion, Boolean checkEnvelopeCreation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTemplateByUuidValidateBeforeCall(UUID uuid, UUID mailbox, UUID templateVersion, Boolean checkEnvelopeCreation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'uuid' is set
        if (uuid == null) {
     ...
     */
    public FullTemplateResponseDTO getTemplateByUuid(UUID uuid, UUID mailbox, UUID templateVersion, Boolean checkEnvelopeCreation) throws ApiException {
     ...
     */
    public ApiResponse<FullTemplateResponseDTO> getTemplateByUuidWithHttpInfo(UUID uuid, UUID mailbox, UUID templateVersion, Boolean checkEnvelopeCreation) throws ApiException {
     ...
     */
    public okhttp3.Call getTemplateByUuidAsync(UUID uuid, UUID mailbox, UUID templateVersion, Boolean checkEnvelopeCreation, final ApiCallback<FullTemplateResponseDTO> _callback) throws ApiException {
