...
public class PermissionControllerApi {
     ...
     */
    public okhttp3.Call resendInvitationCall(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call resendInvitationValidateBeforeCall(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void resendInvitation(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid) throws ApiException {
     ...
     */
    public ApiResponse<Void> resendInvitationWithHttpInfo(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid) throws ApiException {
     ...
     */
    public okhttp3.Call resendInvitationAsync(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call revokeInvitationCall(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call revokeInvitationValidateBeforeCall(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountUuid' is set
        if (accountUuid == null) {
     ...
     */
    public void revokeInvitation(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid) throws ApiException {
     ...
     */
    public ApiResponse<Void> revokeInvitationWithHttpInfo(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid) throws ApiException {
     ...
     */
    public okhttp3.Call revokeInvitationAsync(@javax.annotation.Nonnull UUID accountUuid, @javax.annotation.Nonnull UUID userUuid, final ApiCallback<Void> _callback) throws ApiException {
