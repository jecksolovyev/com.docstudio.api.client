...
public class ApplicationTokenControllerApi {
     ...
     */
    public okhttp3.Call createTokenCall(@javax.annotation.Nonnull CreateAppTokenDTO createAppTokenDTO, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createTokenValidateBeforeCall(@javax.annotation.Nonnull CreateAppTokenDTO createAppTokenDTO, final ApiCallback _callback) throws ApiException {
     ...
     */
    public AppTokenDTO createToken(@javax.annotation.Nonnull CreateAppTokenDTO createAppTokenDTO) throws ApiException {
     ...
     */
    public ApiResponse<AppTokenDTO> createTokenWithHttpInfo(@javax.annotation.Nonnull CreateAppTokenDTO createAppTokenDTO) throws ApiException {
     ...
     */
    public okhttp3.Call createTokenAsync(@javax.annotation.Nonnull CreateAppTokenDTO createAppTokenDTO, final ApiCallback<AppTokenDTO> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call revokeTokenCall(@javax.annotation.Nonnull UUID id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call revokeTokenValidateBeforeCall(@javax.annotation.Nonnull UUID id, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void revokeToken(@javax.annotation.Nonnull UUID id) throws ApiException {
     ...
     */
    public ApiResponse<Void> revokeTokenWithHttpInfo(@javax.annotation.Nonnull UUID id) throws ApiException {
     ...
     */
    public okhttp3.Call revokeTokenAsync(@javax.annotation.Nonnull UUID id, final ApiCallback<Void> _callback) throws ApiException {
