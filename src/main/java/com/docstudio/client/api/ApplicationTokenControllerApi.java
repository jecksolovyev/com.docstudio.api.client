...
public class ApplicationTokenControllerApi {
    ...
    /**
     * Build call for createTokenApplicationToken
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createTokenApplicationTokenCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call createTokenApplicationTokenValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = createTokenApplicationTokenCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<AppTokenDTO> createTokenApplicationToken() throws ApiException {
        ApiResponse<List<AppTokenDTO>> resp = createTokenApplicationTokenWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<AppTokenDTO>> createTokenApplicationTokenWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = createTokenApplicationTokenValidateBeforeCall(null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createTokenApplicationTokenAsync(final ApiCallback<List<AppTokenDTO>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createTokenApplicationTokenValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<AppTokenDTO>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
