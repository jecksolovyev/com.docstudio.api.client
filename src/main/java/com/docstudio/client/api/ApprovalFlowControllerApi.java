...
public class ApprovalFlowControllerApi {
     ...
     */
    public okhttp3.Call createApprovalFlowCall(UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createApprovalFlowValidateBeforeCall(UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO, final ApiCallback _callback) throws ApiException {
        ...
        if (mailboxApprovalFlowDTO == null) {
            throw new ApiException("Missing the required parameter 'mailboxApprovalFlowDTO' when calling createApprovalFlow(Async)");
        }

        return createApprovalFlowCall(mailbox, mailboxApprovalFlowDTO, _callback);
     ...
     */
    public SingleUuidDTO createApprovalFlow(UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO) throws ApiException {
        ApiResponse<SingleUuidDTO> localVarResp = createApprovalFlowWithHttpInfo(mailbox, mailboxApprovalFlowDTO);
     ...
     */
    public ApiResponse<SingleUuidDTO> createApprovalFlowWithHttpInfo(UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO) throws ApiException {
        okhttp3.Call localVarCall = createApprovalFlowValidateBeforeCall(mailbox, mailboxApprovalFlowDTO, null);
     ...
     */
    public okhttp3.Call createApprovalFlowAsync(UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO, final ApiCallback<SingleUuidDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = createApprovalFlowValidateBeforeCall(mailbox, mailboxApprovalFlowDTO, _callback);
        Type localVarReturnType = new TypeToken<SingleUuidDTO>(){}.getType();
     ...
     */
    public okhttp3.Call deleteApprovalFlowCall(UUID mailbox, List<UUID> UUID, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteApprovalFlowValidateBeforeCall(UUID mailbox, List<UUID> UUID, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'mailbox' is set
        if (mailbox == null) {
        ...
        if (UUID == null) {
            throw new ApiException("Missing the required parameter 'UUID' when calling deleteApprovalFlow(Async)");
        }

        return deleteApprovalFlowCall(mailbox, UUID, _callback);
     ...
     */
    public void deleteApprovalFlow(UUID mailbox, List<UUID> UUID) throws ApiException {
        deleteApprovalFlowWithHttpInfo(mailbox, UUID);
    }
     ...
     */
    public ApiResponse<Void> deleteApprovalFlowWithHttpInfo(UUID mailbox, List<UUID> UUID) throws ApiException {
        okhttp3.Call localVarCall = deleteApprovalFlowValidateBeforeCall(mailbox, UUID, null);
     ...
     */
    public okhttp3.Call deleteApprovalFlowAsync(UUID mailbox, List<UUID> UUID, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteApprovalFlowValidateBeforeCall(mailbox, UUID, _callback);
     ...
     */
    public okhttp3.Call updateApprovalFlowCall(UUID flowUuid, UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateApprovalFlowValidateBeforeCall(UUID flowUuid, UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'flowUuid' is set
        if (flowUuid == null) {
        ...
        // verify the required parameter 'mailboxApprovalFlowDTO' is set
        if (mailboxApprovalFlowDTO == null) {
            throw new ApiException("Missing the required parameter 'mailboxApprovalFlowDTO' when calling updateApprovalFlow(Async)");
        }

        return updateApprovalFlowCall(flowUuid, mailbox, mailboxApprovalFlowDTO, _callback);
     ...
     */
    public void updateApprovalFlow(UUID flowUuid, UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO) throws ApiException {
        updateApprovalFlowWithHttpInfo(flowUuid, mailbox, mailboxApprovalFlowDTO);
    }
     ...
     */
    public ApiResponse<Void> updateApprovalFlowWithHttpInfo(UUID flowUuid, UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO) throws ApiException {
        okhttp3.Call localVarCall = updateApprovalFlowValidateBeforeCall(flowUuid, mailbox, mailboxApprovalFlowDTO, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateApprovalFlowAsync(UUID flowUuid, UUID mailbox, MailboxApprovalFlowDTO mailboxApprovalFlowDTO, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateApprovalFlowValidateBeforeCall(flowUuid, mailbox, mailboxApprovalFlowDTO, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
