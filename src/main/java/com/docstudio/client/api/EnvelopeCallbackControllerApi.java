...
public class EnvelopeCallbackControllerApi {
     ...
     */
    public CommonExceptionDTO getCallbackRequestPayload() throws ApiException {
        ApiResponse<CommonExceptionDTO> localVarResp = getCallbackRequestPayloadWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * Check CallbackEnvelopeDataDTO as an example of callback payload
     *
     * @return ApiResponse&lt;CommonExceptionDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<CommonExceptionDTO> getCallbackRequestPayloadWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getCallbackRequestPayloadValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<CommonExceptionDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getCallbackRequestPayloadAsync(final ApiCallback<CommonExceptionDTO> _callback) throws ApiException {
