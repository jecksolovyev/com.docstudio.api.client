...
public class EnvelopeCallbackControllerApi {
     ...
     */
    public com.squareup.okhttp.Call checkCallbackCall(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call checkCallbackValidateBeforeCall(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = checkCallbackCall(callbackUuid, envelopeUuid, mailboxUuid, progressListener, progressRequestListener);
        return call;
    ...
    public EnvelopeCheckResultDTO checkCallback(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid) throws ApiException {
        ApiResponse<EnvelopeCheckResultDTO> resp = checkCallbackWithHttpInfo(callbackUuid, envelopeUuid, mailboxUuid);
        return resp.getData();
    }
    ...
    public ApiResponse<EnvelopeCheckResultDTO> checkCallbackWithHttpInfo(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid) throws ApiException {
        com.squareup.okhttp.Call call = checkCallbackValidateBeforeCall(callbackUuid, envelopeUuid, mailboxUuid, null, null);
     ...
     */
    public com.squareup.okhttp.Call checkCallbackAsync(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid, final ApiCallback<EnvelopeCheckResultDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = checkCallbackValidateBeforeCall(callbackUuid, envelopeUuid, mailboxUuid, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<EnvelopeCheckResultDTO>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call sendCallbackCall(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call sendCallbackValidateBeforeCall(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'callbackUuid' is set
        if (callbackUuid == null) {
        ...
        com.squareup.okhttp.Call call = sendCallbackCall(callbackUuid, envelopeUuid, mailboxUuid, progressListener, progressRequestListener);
        return call;
    ...
    public EnvelopeSendResultDTO sendCallback(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid) throws ApiException {
        ApiResponse<EnvelopeSendResultDTO> resp = sendCallbackWithHttpInfo(callbackUuid, envelopeUuid, mailboxUuid);
        return resp.getData();
    }
    ...
    public ApiResponse<EnvelopeSendResultDTO> sendCallbackWithHttpInfo(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid) throws ApiException {
        com.squareup.okhttp.Call call = sendCallbackValidateBeforeCall(callbackUuid, envelopeUuid, mailboxUuid, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call sendCallbackAsync(UUID callbackUuid, UUID envelopeUuid, UUID mailboxUuid, final ApiCallback<EnvelopeSendResultDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = sendCallbackValidateBeforeCall(callbackUuid, envelopeUuid, mailboxUuid, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<EnvelopeSendResultDTO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
