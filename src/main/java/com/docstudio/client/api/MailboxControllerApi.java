...
public class MailboxControllerApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call searchMailboxesCall(UUID mailbox, String q, String type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call searchMailboxesValidateBeforeCall(UUID mailbox, String q, String type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'mailbox' is set
        if (mailbox == null) {
            throw new ApiException("Missing the required parameter 'mailbox' when calling searchMailboxes(Async)");
        }
        
        com.squareup.okhttp.Call call = searchMailboxesCall(mailbox, q, type, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<MailboxSearchResultDTO> searchMailboxes(UUID mailbox, String q, String type) throws ApiException {
        ApiResponse<List<MailboxSearchResultDTO>> resp = searchMailboxesWithHttpInfo(mailbox, q, type);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<MailboxSearchResultDTO>> searchMailboxesWithHttpInfo(UUID mailbox, String q, String type) throws ApiException {
        com.squareup.okhttp.Call call = searchMailboxesValidateBeforeCall(mailbox, q, type, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchMailboxesAsync(UUID mailbox, String q, String type, final ApiCallback<List<MailboxSearchResultDTO>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = searchMailboxesValidateBeforeCall(mailbox, q, type, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<MailboxSearchResultDTO>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
