...
public class MailboxControllerApi {
     ...
     */
    public okhttp3.Call delete6Call(String checkMessage, UUID mailbox, UUID moveEntitiesToMailbox, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call delete6ValidateBeforeCall(String checkMessage, UUID mailbox, UUID moveEntitiesToMailbox, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void delete6(String checkMessage, UUID mailbox, UUID moveEntitiesToMailbox) throws ApiException {
     ...
     */
    public ApiResponse<Void> delete6WithHttpInfo(String checkMessage, UUID mailbox, UUID moveEntitiesToMailbox) throws ApiException {
     ...
     */
    public okhttp3.Call delete6Async(String checkMessage, UUID mailbox, UUID moveEntitiesToMailbox, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getMailboxesInfo1Call(List<UUID> UUID, Boolean accountName, Boolean accountITN, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMailboxesInfo1ValidateBeforeCall(List<UUID> UUID, Boolean accountName, Boolean accountITN, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'UUID' is set
        if (UUID == null) {
     ...
     */
    public Map<String, MailboxInfoDTO> getMailboxesInfo1(List<UUID> UUID, Boolean accountName, Boolean accountITN) throws ApiException {
     ...
     */
    public ApiResponse<Map<String, MailboxInfoDTO>> getMailboxesInfo1WithHttpInfo(List<UUID> UUID, Boolean accountName, Boolean accountITN) throws ApiException {
     ...
     */
    public okhttp3.Call getMailboxesInfo1Async(List<UUID> UUID, Boolean accountName, Boolean accountITN, final ApiCallback<Map<String, MailboxInfoDTO>> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call leaveMailboxCall(UUID mailboxUuid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call leaveMailboxValidateBeforeCall(UUID mailboxUuid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'mailboxUuid' is set
        if (mailboxUuid == null) {
     ...
     */
    public okhttp3.Call leaveMailboxAsync(UUID mailboxUuid, final ApiCallback<Void> _callback) throws ApiException {
