...
public class MailboxControllerApi {
     ...
     */
    public okhttp3.Call deleteMailboxCall(String checkMessage, UUID mailbox, UUID moveEntitiesToMailbox, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteMailboxValidateBeforeCall(String checkMessage, UUID mailbox, UUID moveEntitiesToMailbox, final ApiCallback _callback) throws ApiException {
        ...
        return deleteMailboxCall(checkMessage, mailbox, moveEntitiesToMailbox, _callback);
    ...
    public ApiResponse<Void> deleteMailboxWithHttpInfo(String checkMessage, UUID mailbox, UUID moveEntitiesToMailbox) throws ApiException {
        okhttp3.Call localVarCall = deleteMailboxValidateBeforeCall(checkMessage, mailbox, moveEntitiesToMailbox, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call deleteMailboxAsync(String checkMessage, UUID mailbox, UUID moveEntitiesToMailbox, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteMailboxValidateBeforeCall(checkMessage, mailbox, moveEntitiesToMailbox, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
