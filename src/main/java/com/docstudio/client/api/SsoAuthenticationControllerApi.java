...
public class SsoAuthenticationControllerApi {
     ...
     */
    public okhttp3.Call loginOauth2Call(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call loginOauth2ValidateBeforeCall(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void loginOauth2(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl) throws ApiException {
     ...
     */
    public ApiResponse<Void> loginOauth2WithHttpInfo(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl) throws ApiException {
     ...
     */
    public okhttp3.Call loginOauth2Async(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call loginSaml2Call(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call loginSaml2ValidateBeforeCall(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'registrationId' is set
        if (registrationId == null) {
     ...
     */
    public void loginSaml2(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl) throws ApiException {
     ...
     */
    public ApiResponse<Void> loginSaml2WithHttpInfo(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl) throws ApiException {
     ...
     */
    public okhttp3.Call loginSaml2Async(@javax.annotation.Nonnull String registrationId, @javax.annotation.Nullable String redirectUrl, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call samlRegistrationIdByDomainCall(@javax.annotation.Nonnull String domain, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call samlRegistrationIdByDomainValidateBeforeCall(@javax.annotation.Nonnull String domain, final ApiCallback _callback) throws ApiException {
     ...
     */
    public SsoEntityDTO samlRegistrationIdByDomain(@javax.annotation.Nonnull String domain) throws ApiException {
     ...
     */
    public ApiResponse<SsoEntityDTO> samlRegistrationIdByDomainWithHttpInfo(@javax.annotation.Nonnull String domain) throws ApiException {
     ...
     */
    public okhttp3.Call samlRegistrationIdByDomainAsync(@javax.annotation.Nonnull String domain, final ApiCallback<SsoEntityDTO> _callback) throws ApiException {
