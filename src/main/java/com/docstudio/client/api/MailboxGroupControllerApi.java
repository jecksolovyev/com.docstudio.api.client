...
public class MailboxGroupControllerApi {
     ...
     */
    public okhttp3.Call updateMailboxGroupCall(UUID accountUuid, UUID groupUuid, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateMailboxGroupValidateBeforeCall(UUID accountUuid, UUID groupUuid, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountUuid' is set
        if (accountUuid == null) {
     ...
     */
    public void updateMailboxGroup(UUID accountUuid, UUID groupUuid) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateMailboxGroupWithHttpInfo(UUID accountUuid, UUID groupUuid) throws ApiException {
     ...
     */
    public okhttp3.Call updateMailboxGroupAsync(UUID accountUuid, UUID groupUuid, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateMailboxGroup1Call(UUID accountUuid, UUID groupUuid, UpdateGroupDTO updateGroupDTO, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateMailboxGroup1ValidateBeforeCall(UUID accountUuid, UUID groupUuid, UpdateGroupDTO updateGroupDTO, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'accountUuid' is set
        if (accountUuid == null) {
     ...
     */
    public GroupInfoDTO updateMailboxGroup1(UUID accountUuid, UUID groupUuid, UpdateGroupDTO updateGroupDTO) throws ApiException {
     ...
     */
    public ApiResponse<GroupInfoDTO> updateMailboxGroup1WithHttpInfo(UUID accountUuid, UUID groupUuid, UpdateGroupDTO updateGroupDTO) throws ApiException {
     ...
     */
    public okhttp3.Call updateMailboxGroup1Async(UUID accountUuid, UUID groupUuid, UpdateGroupDTO updateGroupDTO, final ApiCallback<GroupInfoDTO> _callback) throws ApiException {
