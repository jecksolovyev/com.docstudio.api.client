...
public class EnvelopeSearchControllerApi {
     ...
     */
    public okhttp3.Call searchEnvelopesForApprovalCall(UUID mailbox, SearchApprovalsDTO searchApprovalsDTO, Integer offset, Integer limit, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchEnvelopesForApprovalValidateBeforeCall(UUID mailbox, SearchApprovalsDTO searchApprovalsDTO, Integer offset, Integer limit, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'mailbox' is set
        if (mailbox == null) {
        ...
        return searchEnvelopesForApprovalCall(mailbox, searchApprovalsDTO, offset, limit, _callback);
     ...
     */
    public EnvelopeApprovalPageDTO searchEnvelopesForApproval(UUID mailbox, SearchApprovalsDTO searchApprovalsDTO, Integer offset, Integer limit) throws ApiException {
        ApiResponse<EnvelopeApprovalPageDTO> localVarResp = searchEnvelopesForApprovalWithHttpInfo(mailbox, searchApprovalsDTO, offset, limit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<EnvelopeApprovalPageDTO> searchEnvelopesForApprovalWithHttpInfo(UUID mailbox, SearchApprovalsDTO searchApprovalsDTO, Integer offset, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = searchEnvelopesForApprovalValidateBeforeCall(mailbox, searchApprovalsDTO, offset, limit, null);
     ...
     */
    public okhttp3.Call searchEnvelopesForApprovalAsync(UUID mailbox, SearchApprovalsDTO searchApprovalsDTO, Integer offset, Integer limit, final ApiCallback<EnvelopeApprovalPageDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchEnvelopesForApprovalValidateBeforeCall(mailbox, searchApprovalsDTO, offset, limit, _callback);
        Type localVarReturnType = new TypeToken<EnvelopeApprovalPageDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
