...
public class EnvelopeSearchControllerApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call resetColumnSettingsCall(UUID mailbox, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call resetColumnSettingsValidateBeforeCall(UUID mailbox, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'mailbox' is set
        if (mailbox == null) {
            throw new ApiException("Missing the required parameter 'mailbox' when calling resetColumnSettings(Async)");
        }
        
        com.squareup.okhttp.Call call = resetColumnSettingsCall(mailbox, progressListener, progressRequestListener);
        return call;
    ...
    public List<EnvelopeViewColumn> resetColumnSettings(UUID mailbox) throws ApiException {
        ApiResponse<List<EnvelopeViewColumn>> resp = resetColumnSettingsWithHttpInfo(mailbox);
        return resp.getData();
    }
    ...
    public ApiResponse<List<EnvelopeViewColumn>> resetColumnSettingsWithHttpInfo(UUID mailbox) throws ApiException {
        com.squareup.okhttp.Call call = resetColumnSettingsValidateBeforeCall(mailbox, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call resetColumnSettingsAsync(UUID mailbox, final ApiCallback<List<EnvelopeViewColumn>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = resetColumnSettingsValidateBeforeCall(mailbox, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<EnvelopeViewColumn>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call searchEnvelopesForApprovalCall(SearchApprovalsDTO body, UUID mailbox, Integer offset, Integer limit, Boolean uuidOnly, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call searchEnvelopesForApprovalValidateBeforeCall(SearchApprovalsDTO body, UUID mailbox, Integer offset, Integer limit, Boolean uuidOnly, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
        ...
        com.squareup.okhttp.Call call = searchEnvelopesForApprovalCall(body, mailbox, offset, limit, uuidOnly, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public EnvelopeApprovalPageDTO searchEnvelopesForApproval(SearchApprovalsDTO body, UUID mailbox, Integer offset, Integer limit, Boolean uuidOnly) throws ApiException {
        ApiResponse<EnvelopeApprovalPageDTO> resp = searchEnvelopesForApprovalWithHttpInfo(body, mailbox, offset, limit, uuidOnly);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<EnvelopeApprovalPageDTO> searchEnvelopesForApprovalWithHttpInfo(SearchApprovalsDTO body, UUID mailbox, Integer offset, Integer limit, Boolean uuidOnly) throws ApiException {
        com.squareup.okhttp.Call call = searchEnvelopesForApprovalValidateBeforeCall(body, mailbox, offset, limit, uuidOnly, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchEnvelopesForApprovalAsync(SearchApprovalsDTO body, UUID mailbox, Integer offset, Integer limit, Boolean uuidOnly, final ApiCallback<EnvelopeApprovalPageDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = searchEnvelopesForApprovalValidateBeforeCall(body, mailbox, offset, limit, uuidOnly, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<EnvelopeApprovalPageDTO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
