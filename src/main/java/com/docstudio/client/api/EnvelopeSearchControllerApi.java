...
public class EnvelopeSearchControllerApi {
     ...
     */
    public okhttp3.Call deleteColumn1Call(UUID mailbox, DeleteEnvColumnDTO deleteEnvColumnDTO, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteColumn1ValidateBeforeCall(UUID mailbox, DeleteEnvColumnDTO deleteEnvColumnDTO, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'mailbox' is set
        if (mailbox == null) {
     ...
     */
    public void deleteColumn1(UUID mailbox, DeleteEnvColumnDTO deleteEnvColumnDTO) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteColumn1WithHttpInfo(UUID mailbox, DeleteEnvColumnDTO deleteEnvColumnDTO) throws ApiException {
     ...
     */
    public okhttp3.Call deleteColumn1Async(UUID mailbox, DeleteEnvColumnDTO deleteEnvColumnDTO, final ApiCallback<Void> _callback) throws ApiException {
