...
public class BillingPaymentDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("invoiceId", "provider", "firstName", "lastName", "email"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("invoiceId", "provider", "firstName", "lastName"));
  }
