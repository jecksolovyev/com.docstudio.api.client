...
public class DictionaryColumnRequestDTO {
  ...
  public DictionaryColumnRequestDTO name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DictionaryColumnRequestDTO order(@javax.annotation.Nonnull Integer order) {
    this.order = order;
    return this;
  }
  ...
  public DictionaryColumnRequestDTO width(@javax.annotation.Nullable Integer width) {
    this.width = width;
    return this;
  }
   ...
   * @return the DictionaryColumnRequestDTO instance itself
   */
  public DictionaryColumnRequestDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, dictionaryColumnRequestDTO.name) &&
        ...
        Objects.equals(this.additionalProperties, dictionaryColumnRequestDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, order, width, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "order", "width"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "order"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DictionaryColumnRequestDTO>() {
           ...
           public DictionaryColumnRequestDTO read(JsonReader in) throws IOException {
             ...
             DictionaryColumnRequestDTO instance = thisAdapter.fromJsonTree(jsonObj);
