...
public class AuditTrailDTO {
   ...
   * @return the AuditTrailDTO instance itself
   */
  public AuditTrailDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.envelopeUuid, auditTrailDTO.envelopeUuid) &&
        ...
        Objects.equals(this.additionalProperties, auditTrailDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(envelopeUuid, dateTime, userUuid, mailboxUuid, mailboxName, userFirstAndLastName, operation, ip, browser, os, geolocation, description, latitude, longitude, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("envelopeUuid", "dateTime", "userUuid", "mailboxUuid", "mailboxName", "userFirstAndLastName", "operation", "ip", "browser", "os", "geolocation", "description", "latitude", "longitude"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AuditTrailDTO>() {
           ...
           public AuditTrailDTO read(JsonReader in) throws IOException {
             ...
             AuditTrailDTO instance = thisAdapter.fromJsonTree(jsonObj);
