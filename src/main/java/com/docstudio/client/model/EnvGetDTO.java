...
public class EnvGetDTO {
  ...
  public EnvGetDTO sentAt(OffsetDateTime sentAt) {
    this.sentAt = sentAt;
    return this;
  }
  ...
  public EnvGetDTO labels(Set<UUID> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public void setLabels(Set<UUID> labels) {
    this.labels = labels;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, data, createdAt, receivedAt, sentAt, labels, total, completed, chainUuid, chainedByMe, approvalFlowUuid, status, sender, deleted, archived, shared, sharedTo);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnvGetDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnvGetDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
