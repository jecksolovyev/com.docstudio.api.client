...
public class AccountDTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, inn, createdAt, modifiedAt, mailboxes, users, logo, brand, currency, timezone, allowCreatePersonalMailboxWithRole, allowMicrosoftOfficeViewer, additionalProperties);
  }
