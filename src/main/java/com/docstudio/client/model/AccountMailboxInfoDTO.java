...
public class AccountMailboxInfoDTO {
  ...
  public AccountMailboxInfoDTO groups(Set<NameUuidDTO> groups) {
    this.groups = groups;
    return this;
  }
  ...
  public void setGroups(Set<NameUuidDTO> groups) {
    this.groups = groups;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, hideNameForAccounts, usersCount, aliases, system, groups);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountMailboxInfoDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountMailboxInfoDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
