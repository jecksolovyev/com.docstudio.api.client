...
public class AccountMailboxInfoDTO {
  ...
  private List<NameUuidDTO> groups = null;
  ...
  **/
  ...
  public AccountMailboxInfoDTO groups(List<NameUuidDTO> groups) {
    this.groups = groups;
    return this;
  }
  ...
  public AccountMailboxInfoDTO addGroupsItem(NameUuidDTO groupsItem) {
    if (this.groups == null) {
      this.groups = new ArrayList<NameUuidDTO>();
    }
   ...
   * @return groups
  **/
  @Schema(description = "Mailbox groups")
  public List<NameUuidDTO> getGroups() {
    return groups;
  }

  public void setGroups(List<NameUuidDTO> groups) {
    this.groups = groups;
  }
