...
import com.docstudio.client.model.ScenarioStepDTO;
...
public class ScenarioDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "name", "description", "mailboxUuid", "access", "sharedTo", "steps", "addToChain"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "description", "access", "steps"));
  }
