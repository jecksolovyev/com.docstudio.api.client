...
public class IntegrationDTO {
  ...
  private Map<String, String> protocolSettings = new HashMap<String, String>();
  ...
  **/
  @Schema(required = true, description = "Integration protocol settings")
