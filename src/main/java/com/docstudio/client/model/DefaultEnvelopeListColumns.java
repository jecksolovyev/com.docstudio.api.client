...
public class DefaultEnvelopeListColumns {
   ...
   * @return the DefaultEnvelopeListColumns instance itself
   */
  public DefaultEnvelopeListColumns putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columns, defaultEnvelopeListColumns.columns) &&
        ...
        Objects.equals(this.additionalProperties, defaultEnvelopeListColumns.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(columns, defaultMinWidth, defaultWidth, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("columns", "defaultMinWidth", "defaultWidth"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DefaultEnvelopeListColumns>() {
           ...
           public DefaultEnvelopeListColumns read(JsonReader in) throws IOException {
             ...
             DefaultEnvelopeListColumns instance = thisAdapter.fromJsonTree(jsonObj);
