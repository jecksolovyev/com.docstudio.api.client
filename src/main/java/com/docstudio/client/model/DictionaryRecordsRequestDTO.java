...
public class DictionaryRecordsRequestDTO {
  ...
  public DictionaryRecordsRequestDTO values(@javax.annotation.Nullable Set<Object> values) {
    this.values = values;
    return this;
  }

  public DictionaryRecordsRequestDTO addValuesItem(Object valuesItem) {
    if (this.values == null) {
  ...
  public void setValues(@javax.annotation.Nullable Set<Object> values) {
    this.values = values;
  }
   ...
   * @return the DictionaryRecordsRequestDTO instance itself
   */
  public DictionaryRecordsRequestDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columnUuid, dictionaryRecordsRequestDTO.columnUuid) &&
        ...
        Objects.equals(this.additionalProperties, dictionaryRecordsRequestDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(columnUuid, values, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("columnUuid", "values"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("columnUuid"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DictionaryRecordsRequestDTO>() {
           ...
           public DictionaryRecordsRequestDTO read(JsonReader in) throws IOException {
             ...
             DictionaryRecordsRequestDTO instance = thisAdapter.fromJsonTree(jsonObj);
