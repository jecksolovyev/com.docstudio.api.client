...
public class DictionaryColumnValueRequestDTO {
  ...
  public DictionaryColumnValueRequestDTO uuid(@javax.annotation.Nonnull UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public DictionaryColumnValueRequestDTO value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
   ...
   * @return the DictionaryColumnValueRequestDTO instance itself
   */
  public DictionaryColumnValueRequestDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, dictionaryColumnValueRequestDTO.uuid) &&
        ...
        Objects.equals(this.additionalProperties, dictionaryColumnValueRequestDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, value, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "value"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("uuid", "value"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DictionaryColumnValueRequestDTO>() {
           ...
           public DictionaryColumnValueRequestDTO read(JsonReader in) throws IOException {
             ...
             DictionaryColumnValueRequestDTO instance = thisAdapter.fromJsonTree(jsonObj);
