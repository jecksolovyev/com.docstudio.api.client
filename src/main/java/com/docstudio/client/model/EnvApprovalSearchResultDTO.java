...
public class EnvApprovalSearchResultDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("envelopeUuid", "subject", "message", "createdAt", "status", "mailboxUUID", "accountUuid", "mailboxName", "total", "completed", "templateUuid", "templateName", "seenAt", "expiredAfter", "approvalFlowUuid", "urgent"));
