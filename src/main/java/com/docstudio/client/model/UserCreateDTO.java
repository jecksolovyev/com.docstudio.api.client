...
public class UserCreateDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("email", "password", "firstName", "lastName", "companyName", "inn", "mailboxes", "locale", "dateLocale", "timezone", "agreed", "phone"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("email", "firstName", "lastName", "agreed"));
  }
