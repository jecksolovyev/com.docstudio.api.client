...
public class LoginEnvelopeResponseDTO {
   ...
   * @return the LoginEnvelopeResponseDTO instance itself
   */
  public LoginEnvelopeResponseDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, loginEnvelopeResponseDTO.token) &&
        ...
        Objects.equals(this.additionalProperties, loginEnvelopeResponseDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, envelopeUuid, mailboxUuid, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("token", "envelopeUuid", "mailboxUuid"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoginEnvelopeResponseDTO>() {
           ...
           public LoginEnvelopeResponseDTO read(JsonReader in) throws IOException {
             ...
             LoginEnvelopeResponseDTO instance = thisAdapter.fromJsonTree(jsonObj);
