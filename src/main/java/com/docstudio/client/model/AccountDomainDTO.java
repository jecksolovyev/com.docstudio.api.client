...
import com.docstudio.client.model.AccountDomainVerifyInfo;
...
public class AccountDomainDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "accountUuid", "domain", "verifyInfo", "verifyMethod", "status", "verificationDate", "createDate", "lastCheckDate", "ssoIdProvider"));
