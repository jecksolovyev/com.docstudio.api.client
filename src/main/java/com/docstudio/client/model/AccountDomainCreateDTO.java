...
public class AccountDomainCreateDTO {
  ...
  public AccountDomainCreateDTO ssoIdProviderUuid(UUID ssoIdProviderUuid) {
  ...
  public AccountDomainCreateDTO domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ssoIdProviderUuid, domain);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountDomainCreateDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountDomainCreateDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
