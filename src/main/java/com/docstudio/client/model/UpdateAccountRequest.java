...
public class UpdateAccountRequest {
  ...
  public UpdateAccountRequest corporateProfileEditRestricted(@javax.annotation.Nullable Boolean corporateProfileEditRestricted) {
    this.corporateProfileEditRestricted = corporateProfileEditRestricted;
    return this;
  }

  /**
   * Restrict profile editing for corporate users
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateAccountRequest.name) &&
        ...
        Objects.equals(this.corporateProfileEditRestricted, updateAccountRequest.corporateProfileEditRestricted)&&
        Objects.equals(this.additionalProperties, updateAccountRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, inn, logo, brand, timezone, allowCreatePersonalMailboxWithRole, allowMicrosoftOfficeViewer, corporateProfileEditRestricted, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "inn", "logo", "brand", "timezone", "allowCreatePersonalMailboxWithRole", "allowMicrosoftOfficeViewer", "corporateProfileEditRestricted"));
