...
public class FieldRestriction {
   ...
   * @return the FieldRestriction instance itself
   */
  public FieldRestriction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.einksign, fieldRestriction.einksign) &&
        ...
        Objects.equals(this.additionalProperties, fieldRestriction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(einksign, initials, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("einksign", "initials"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FieldRestriction>() {
           ...
           public FieldRestriction read(JsonReader in) throws IOException {
             ...
             FieldRestriction instance = thisAdapter.fromJsonTree(jsonObj);
