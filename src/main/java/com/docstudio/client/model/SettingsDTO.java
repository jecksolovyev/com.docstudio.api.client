...
public class SettingsDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(buildVersion, applicationName, theme, podName, links, locales, testMode, envelope, template, user, pageScripts, chunkUpload, crypto, logosProperties, emailProperties, billing, sso, geolocation, googleMapsApiKey);
  }
