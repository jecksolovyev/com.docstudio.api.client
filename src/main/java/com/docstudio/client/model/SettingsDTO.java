...
import com.docstudio.client.model.DefaultEnvelopeListColumns;
import com.docstudio.client.model.EmailProperties;
import com.docstudio.client.model.EnvelopeRestrictions;
import com.docstudio.client.model.ExchangeProperties;
import com.docstudio.client.model.ExchangeProtocolProps;
...
public class SettingsDTO {
  ...
  public static final String SERIALIZED_NAME_SUPPORT_CHAT_PROVIDER = "supportChatProvider";
  @SerializedName(SERIALIZED_NAME_SUPPORT_CHAT_PROVIDER)
  @javax.annotation.Nullable
  private String supportChatProvider;
  ...
  @javax.annotation.Nullable
  private Map<String, ExchangeProtocolProps> exchangeProtocols = new HashMap<>();
  ...
  public SettingsDTO supportChatProvider(@javax.annotation.Nullable String supportChatProvider) {
    this.supportChatProvider = supportChatProvider;
    return this;
  }

  /**
   * Support live chat provider name
   * @return supportChatProvider
   */
  @javax.annotation.Nullable
  public String getSupportChatProvider() {
    return supportChatProvider;
  }

  public void setSupportChatProvider(@javax.annotation.Nullable String supportChatProvider) {
    this.supportChatProvider = supportChatProvider;
  }
  ...
  public SettingsDTO exchange(@javax.annotation.Nullable ExchangeProperties exchange) {
  ...
  public void setExchange(@javax.annotation.Nullable ExchangeProperties exchange) {
    this.exchange = exchange;
  }


  public SettingsDTO exchangeProtocols(@javax.annotation.Nullable Map<String, ExchangeProtocolProps> exchangeProtocols) {
    this.exchangeProtocols = exchangeProtocols;
    return this;
  }

  public SettingsDTO putExchangeProtocolsItem(String key, ExchangeProtocolProps exchangeProtocolsItem) {
   ...
   */
  @javax.annotation.Nullable
  public Map<String, ExchangeProtocolProps> getExchangeProtocols() {
    return exchangeProtocols;
  }

  public void setExchangeProtocols(@javax.annotation.Nullable Map<String, ExchangeProtocolProps> exchangeProtocols) {
    this.exchangeProtocols = exchangeProtocols;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.buildVersion, settingsDTO.buildVersion) &&
        ...
        Objects.equals(this.supportChatProvider, settingsDTO.supportChatProvider) &&
        ...
        Objects.equals(this.exchange, settingsDTO.exchange) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(buildVersion, applicationName, theme, supportChatProvider, hideUnauthorizedFunctions, podName, links, locales, testMode, envelope, template, user, pageScripts, chunkUpload, crypto, logosProperties, emailProperties, billing, sso, geolocation, googleMapsApiKey, pdf, mailbox, exchange, exchangeProtocols, infoLinks, supportedBarcodes, defaultEnvelopeListColumns, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    supportChatProvider: ").append(toIndentedString(supportChatProvider)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("buildVersion", "applicationName", "theme", "supportChatProvider", "hideUnauthorizedFunctions", "podName", "links", "locales", "testMode", "envelope", "template", "user", "pageScripts", "chunkUpload", "crypto", "logosProperties", "emailProperties", "billing", "sso", "geolocation", "googleMapsApiKey", "pdf", "mailbox", "exchange", "exchangeProtocols", "infoLinks", "supportedBarcodes", "defaultEnvelopeListColumns"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("supportChatProvider") != null && !jsonObj.get("supportChatProvider").isJsonNull()) && !jsonObj.get("supportChatProvider").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `supportChatProvider` to be a primitive type in the JSON string but got `%s`", jsonObj.get("supportChatProvider").toString()));
      }
      ...
      if (jsonObj.get("exchange") != null && !jsonObj.get("exchange").isJsonNull()) {
        ExchangeProperties.validateJsonElement(jsonObj.get("exchange"));
      }
