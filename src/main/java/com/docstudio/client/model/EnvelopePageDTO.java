...
public class EnvelopePageDTO {
  ...
  public EnvelopePageDTO senders(Set<EnvelopeSenderDTO> senders) {
  ...
  public void setSenders(Set<EnvelopeSenderDTO> senders) {
    this.senders = senders;
  }


  public EnvelopePageDTO templates(Set<EnvelopeTemplateInfoDTO> templates) {
