...
import com.docstudio.client.model.EnvelopeTemplateInfoDTO;
...
public class EnvelopePageDTO {
   ...
   * @return the EnvelopePageDTO instance itself
   */
  public EnvelopePageDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalElements, envelopePageDTO.totalElements) &&
        ...
        Objects.equals(this.additionalProperties, envelopePageDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalElements, sizeRequested, numberOfElements, data, searchFields, columns, senders, templates, sendersInfo, templatesInfo, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("totalElements", "sizeRequested", "numberOfElements", "data", "searchFields", "columns", "senders", "templates", "sendersInfo", "templatesInfo"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EnvelopePageDTO>() {
           ...
           public EnvelopePageDTO read(JsonReader in) throws IOException {
             ...
             EnvelopePageDTO instance = thisAdapter.fromJsonTree(jsonObj);
