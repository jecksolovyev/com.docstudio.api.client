...
public class FailedEnvelopeCallbackFilterDTO {
  ...
  public FailedEnvelopeCallbackFilterDTO labels(@javax.annotation.Nullable Set<Object> labels) {
    this.labels = labels;
    return this;
  }

  public FailedEnvelopeCallbackFilterDTO addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("labels", "status", "subject", "createDate", "receiveDate", "expireDate", "template", "sender"));
