...
public class EnvCancellationRequestDTO {
  ...
  public EnvCancellationRequestDTO uuids(Set<UUID> uuids) {
    this.uuids = uuids;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnvCancellationRequestDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnvCancellationRequestDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
