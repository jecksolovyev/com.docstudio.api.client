...
public class EnvCancellationRequestDTO {
  ...
  public EnvCancellationRequestDTO uuids(@javax.annotation.Nonnull Set<Object> uuids) {
    this.uuids = uuids;
    return this;
  }

  public EnvCancellationRequestDTO addUuidsItem(Object uuidsItem) {
    if (this.uuids == null) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuids", "comment"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("uuids", "comment"));
  }
