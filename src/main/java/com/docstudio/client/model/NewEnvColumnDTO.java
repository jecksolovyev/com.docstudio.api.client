...
public class NewEnvColumnDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fieldName", "type", "order", "visible", "width"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("fieldName", "type"));
  }
