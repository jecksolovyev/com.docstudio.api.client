...
public class MailboxApprovalFlowGetDTO {
  ...
  public MailboxApprovalFlowGetDTO sharedForMailboxes(Set<MailboxNameUuidDTO> sharedForMailboxes) {
  ...
  public void setSharedForMailboxes(Set<MailboxNameUuidDTO> sharedForMailboxes) {
    this.sharedForMailboxes = sharedForMailboxes;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MailboxApprovalFlowGetDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MailboxApprovalFlowGetDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
