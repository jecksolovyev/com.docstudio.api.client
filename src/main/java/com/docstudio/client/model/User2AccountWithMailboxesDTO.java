...
public class User2AccountWithMailboxesDTO {
  ...
  public User2AccountWithMailboxesDTO uuid(@javax.annotation.Nullable UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public User2AccountWithMailboxesDTO name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public User2AccountWithMailboxesDTO system(@javax.annotation.Nullable Boolean system) {
    this.system = system;
    return this;
  }
  ...
  public User2AccountWithMailboxesDTO allowMicrosoftOfficeViewer(@javax.annotation.Nullable Boolean allowMicrosoftOfficeViewer) {
  ...
  public User2AccountWithMailboxesDTO corporateProfileEditRestricted(@javax.annotation.Nullable Boolean corporateProfileEditRestricted) {
  ...
  public User2AccountWithMailboxesDTO company(@javax.annotation.Nullable Boolean company) {
  ...
  public User2AccountWithMailboxesDTO permissions(@javax.annotation.Nullable Set<Integer> permissions) {
  ...
  public User2AccountWithMailboxesDTO mailboxes(@javax.annotation.Nullable List<MailboxProfileDTO> mailboxes) {
  ...
  public User2AccountWithMailboxesDTO documentSharingProviders(@javax.annotation.Nullable Set<Object> documentSharingProviders) {
    this.documentSharingProviders = documentSharingProviders;
    return this;
  }

  public User2AccountWithMailboxesDTO addDocumentSharingProvidersItem(Object documentSharingProvidersItem) {
   ...
   * @return the User2AccountWithMailboxesDTO instance itself
   */
  public User2AccountWithMailboxesDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, user2AccountWithMailboxesDTO.uuid) &&
        ...
        Objects.equals(this.allowMicrosoftOfficeViewer, user2AccountWithMailboxesDTO.allowMicrosoftOfficeViewer) &&
        Objects.equals(this.corporateProfileEditRestricted, user2AccountWithMailboxesDTO.corporateProfileEditRestricted) &&
        Objects.equals(this.company, user2AccountWithMailboxesDTO.company) &&
        ...
        Objects.equals(this.documentSharingProviders, user2AccountWithMailboxesDTO.documentSharingProviders)&&
        Objects.equals(this.additionalProperties, user2AccountWithMailboxesDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, system, allowMicrosoftOfficeViewer, corporateProfileEditRestricted, company, permissions, mailboxes, documentSharingProviders, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "name", "system", "allowMicrosoftOfficeViewer", "corporateProfileEditRestricted", "company", "permissions", "mailboxes", "documentSharingProviders"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<User2AccountWithMailboxesDTO>() {
           ...
           public User2AccountWithMailboxesDTO read(JsonReader in) throws IOException {
             ...
             User2AccountWithMailboxesDTO instance = thisAdapter.fromJsonTree(jsonObj);
