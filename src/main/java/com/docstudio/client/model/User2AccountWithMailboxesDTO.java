...
public class User2AccountWithMailboxesDTO {
  ...
  @javax.annotation.Nullable
  private Set<String> documentSharingProviders = new LinkedHashSet<>();
  ...
  public User2AccountWithMailboxesDTO documentSharingProviders(@javax.annotation.Nullable Set<String> documentSharingProviders) {
    this.documentSharingProviders = documentSharingProviders;
    return this;
  }

  public User2AccountWithMailboxesDTO addDocumentSharingProvidersItem(String documentSharingProvidersItem) {
   ...
   */
  @javax.annotation.Nullable
  public Set<String> getDocumentSharingProviders() {
    return documentSharingProviders;
  }

  public void setDocumentSharingProviders(@javax.annotation.Nullable Set<String> documentSharingProviders) {
    this.documentSharingProviders = documentSharingProviders;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, system, allowMicrosoftOfficeViewer, company, permissions, mailboxes, documentSharingProviders, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("documentSharingProviders");
