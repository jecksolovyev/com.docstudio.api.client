...
public class PageDTOObject {
   ...
   * @return the PageDTOObject instance itself
   */
  public PageDTOObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalElements, pageDTOObject.totalElements) &&
        ...
        Objects.equals(this.additionalProperties, pageDTOObject.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageDTOObject>() {
           ...
           public PageDTOObject read(JsonReader in) throws IOException {
             ...
             PageDTOObject instance = thisAdapter.fromJsonTree(jsonObj);
