...
public class ProcessStatus {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(total, processed, successful, details, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("total", "processed", "successful", "details"));
