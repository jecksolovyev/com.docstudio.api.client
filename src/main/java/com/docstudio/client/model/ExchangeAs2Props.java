...
public class ExchangeAs2Props {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("url", "encryptionAlgorithms", "signingAlgorithms"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("url", "encryptionAlgorithms", "signingAlgorithms"));
  }
