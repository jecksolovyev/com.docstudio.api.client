...
import com.docstudio.client.model.AccountBillingCounterValueDTO;
import com.docstudio.client.model.AccountBillingEventDTO;
import com.docstudio.client.model.AccountBillingTariffInfoDTO;
...
public class AccountBillingInfoDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("tariffs", "balance", "currency", "counters", "events"));
