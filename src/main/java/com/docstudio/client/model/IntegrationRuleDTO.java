...
public class IntegrationRuleDTO {
   ...
   * @return the IntegrationRuleDTO instance itself
   */
  public IntegrationRuleDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.integrationRuleUuid, integrationRuleDTO.integrationRuleUuid) &&
        ...
        Objects.equals(this.additionalProperties, integrationRuleDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(integrationRuleUuid, accountUuid, mailboxUuid, active, in, name, templateUuid, templateName, versionUuid, matchingPattern, matchingPatternSrc, namingPattern, rule, zipStructureName, excludeZipFiles, multipleEnvelopes, attributes, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<IntegrationRuleDTO>() {
           ...
           public IntegrationRuleDTO read(JsonReader in) throws IOException {
             ...
             IntegrationRuleDTO instance = thisAdapter.fromJsonTree(jsonObj);
