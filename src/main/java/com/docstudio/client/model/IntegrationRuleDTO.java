...
public class IntegrationRuleDTO {
  ...
  @SerializedName("excludeZipFiles")
  private String excludeZipFiles = null;

  @SerializedName("multipleEnvelopes")
  private Boolean multipleEnvelopes = null;
  ...
  **/
   ...
   * @return accountUuid
  **/
  @Schema(required = true, description = "Account uuid")
  ...
  **/
   ...
   * @return rule
  **/
  @Schema(description = "XSLT mapping")
  ...
  **/
  @Schema(description = "Mask to exclude some files from ZIP. c - for signature/processing Certificate, p - for Printable version, a - for Audit trail")
  ...
  **/
  @Schema(description = "Rule using for creating multiple envelopes")
  public Boolean isMultipleEnvelopes() {
    return multipleEnvelopes;
  }
   ...
   * @return attributes
  **/
  @Schema(description = "Some additional attributes (XPATH can be used as a value)")
