...
public class DictionaryResponseDTO {
  ...
  **/
  ...
  public DictionaryResponseDTO mailboxUuid(UUID mailboxUuid) {
   ...
   * @return mailboxUuid
  **/
  @Schema(description = "Owner of the dictionary")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, access, archive, createdAt, editable, filteredAccessOnly, recordsCount, columns, status, mailboxUuid);
  }
