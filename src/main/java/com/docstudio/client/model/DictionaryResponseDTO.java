...
public class DictionaryResponseDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "name", "description", "access", "archive", "createdAt", "editable", "filteredAccessOnly", "recordsCount", "columns", "status", "mailboxUuid"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("uuid", "name", "description", "access", "archive", "createdAt", "editable", "filteredAccessOnly"));
  }
