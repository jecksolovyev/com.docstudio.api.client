...
public class EnvelopeToMailboxDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(envelopeUuid, subject, message, archived, deleted, sentByMe, createdAt, receivedAt, seenAt, expiredAfter, sharingForbidden, status, accountUUID, mailboxUUID, mailboxName, total, completed, labels, templateUuid, templateName, invitationCode, chainUuid, chainedByMe, extraFields);
  }
