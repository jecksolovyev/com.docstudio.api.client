...
import com.docstudio.client.model.EnvelopeExtraFieldDTO;
...
public class EnvelopeToMailboxDTO {
  ...
  public EnvelopeToMailboxDTO labels(@javax.annotation.Nullable List<Object> labels) {
    this.labels = labels;
    return this;
  }

  public EnvelopeToMailboxDTO addLabelsItem(Object labelsItem) {
    if (this.labels == null) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("envelopeUuid", "subject", "message", "archived", "deleted", "shared", "sentByMe", "createdAt", "receivedAt", "sentAt", "seenAt", "expiredAfter", "sharingForbidden", "status", "accountUUID", "mailboxUUID", "mailboxName", "total", "completed", "labels", "templateUuid", "templateVersion", "templateName", "invitationCode", "chainUuid", "chainedByMe", "extraFields"));
