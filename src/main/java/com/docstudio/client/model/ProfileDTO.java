...
public class ProfileDTO {
  ...
  **/
  ...
  public ProfileDTO initials(String initials) {
   ...
   * @return initials
  **/
  @Schema(description = "Saved initials")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, email, firstName, lastName, status, dateLocale, locale, timezone, corporateUser, ssoEnabled, autoDepositMailboxUuid, phone, displayExactDate, signature, initials, accounts);
  }
