...
public class EnvelopeSenderDTO {
  ...
  public EnvelopeSenderDTO() {
  }

  public EnvelopeSenderDTO mailboxUuid(@javax.annotation.Nullable UUID mailboxUuid) {
  ...
  public EnvelopeSenderDTO mailboxName(@javax.annotation.Nullable String mailboxName) {
  ...
  public EnvelopeSenderDTO accountUuid(@javax.annotation.Nullable UUID accountUuid) {
  ...
  public EnvelopeSenderDTO accountName(@javax.annotation.Nullable String accountName) {
   ...
   * @return the EnvelopeSenderDTO instance itself
   */
  public EnvelopeSenderDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mailboxUuid, envelopeSenderDTO.mailboxUuid) &&
        ...
        Objects.equals(this.additionalProperties, envelopeSenderDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mailboxUuid, mailboxName, accountUuid, accountName, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("mailboxUuid", "mailboxName", "accountUuid", "accountName"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnvelopeSenderDTO
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnvelopeSenderDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnvelopeSenderDTO is not found in the empty JSON string", EnvelopeSenderDTO.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnvelopeSenderDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnvelopeSenderDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnvelopeSenderDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnvelopeSenderDTO.class));

       return (TypeAdapter<T>) new TypeAdapter<EnvelopeSenderDTO>() {
           @Override
           public void write(JsonWriter out, EnvelopeSenderDTO value) throws IOException {
           ...
           @Override
           public EnvelopeSenderDTO read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             EnvelopeSenderDTO instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of EnvelopeSenderDTO given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnvelopeSenderDTO
   * @throws IOException if the JSON string is invalid with respect to EnvelopeSenderDTO
   */
  public static EnvelopeSenderDTO fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnvelopeSenderDTO.class);
  }

  /**
   * Convert an instance of EnvelopeSenderDTO to an JSON string
   *
   * @return JSON string
   */
