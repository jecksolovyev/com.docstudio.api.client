...
public class CallbackEnvelopeDataDTO {
  ...
  public CallbackEnvelopeDataDTO label(@javax.annotation.Nullable Set<Object> label) {
    this.label = label;
    return this;
  }

  public CallbackEnvelopeDataDTO addLabelItem(Object labelItem) {
    if (this.label == null) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "status", "subject", "label", "receiveDate", "expireDate", "template", "sender", "mailbox"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("uuid", "status", "subject", "receiveDate", "template", "sender", "mailbox"));
  }
