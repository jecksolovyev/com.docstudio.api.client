...
public class AccountBillingTariffInfoDTO {
   ...
   * @return the AccountBillingTariffInfoDTO instance itself
   */
  public AccountBillingTariffInfoDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, accountBillingTariffInfoDTO.id) &&
        ...
        Objects.equals(this.additionalProperties, accountBillingTariffInfoDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, displayName, validFrom, validTo, nextPriceApply, price, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "displayName", "validFrom", "validTo", "nextPriceApply", "price"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AccountBillingTariffInfoDTO>() {
           ...
           public AccountBillingTariffInfoDTO read(JsonReader in) throws IOException {
             ...
             AccountBillingTariffInfoDTO instance = thisAdapter.fromJsonTree(jsonObj);
