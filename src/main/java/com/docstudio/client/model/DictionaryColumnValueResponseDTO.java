...
public class DictionaryColumnValueResponseDTO {
   ...
   * @return the DictionaryColumnValueResponseDTO instance itself
   */
  public DictionaryColumnValueResponseDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.recordUuid, dictionaryColumnValueResponseDTO.recordUuid) &&
        ...
        Objects.equals(this.additionalProperties, dictionaryColumnValueResponseDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recordUuid, data, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("recordUuid", "data"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("recordUuid", "data"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DictionaryColumnValueResponseDTO>() {
           ...
           public DictionaryColumnValueResponseDTO read(JsonReader in) throws IOException {
             ...
             DictionaryColumnValueResponseDTO instance = thisAdapter.fromJsonTree(jsonObj);
