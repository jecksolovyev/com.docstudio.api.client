...
public class SearchApprovalsDTO {
  ...
  public SearchApprovalsDTO status(Set<StatusEnum> status) {
    this.status = status;
    return this;
  }
  ...
  public SearchApprovalsDTO template(Set<UUID> template) {
  ...
  public SearchApprovalsDTO initiator(Set<UUID> initiator) {
  ...
  public void setInitiator(Set<UUID> initiator) {
    this.initiator = initiator;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchApprovalsDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchApprovalsDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
