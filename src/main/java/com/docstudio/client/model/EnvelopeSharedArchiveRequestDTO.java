...
public class EnvelopeSharedArchiveRequestDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("emails", "envelopeUuids", "excludeFiles", "zipStructureName"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("emails", "envelopeUuids"));
  }
