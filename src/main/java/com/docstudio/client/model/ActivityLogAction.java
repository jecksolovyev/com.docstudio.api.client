...
public enum ActivityLogAction {
  ...
  @SerializedName("template-zip-structure-created")
  TEMPLATE_ZIP_STRUCTURE_CREATED("template-zip-structure-created"),
  @SerializedName("template-zip-structure-deleted")
  ...
  @SerializedName("user-left-mailbox")
  USER_LEFT_MAILBOX("user-left-mailbox"),
  @SerializedName("user-profile-updated-by-admin")
