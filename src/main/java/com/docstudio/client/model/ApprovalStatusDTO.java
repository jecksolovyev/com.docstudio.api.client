...
public class ApprovalStatusDTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, comment, envelopes);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApprovalStatusDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ApprovalStatusDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
