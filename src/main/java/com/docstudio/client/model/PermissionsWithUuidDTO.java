...
public class PermissionsWithUuidDTO {
  ...
  public PermissionsWithUuidDTO permissions(@javax.annotation.Nullable Set<Integer> permissions) {
  ...
  public PermissionsWithUuidDTO roles(@javax.annotation.Nullable Set<UUID> roles) {
    this.roles = roles;
    return this;
  }
  ...
  public PermissionsWithUuidDTO uuid(@javax.annotation.Nonnull UUID uuid) {
    this.uuid = uuid;
    return this;
  }
   ...
   * @return the PermissionsWithUuidDTO instance itself
   */
  public PermissionsWithUuidDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.permissions, permissionsWithUuidDTO.permissions) &&
        ...
        Objects.equals(this.additionalProperties, permissionsWithUuidDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(permissions, roles, uuid, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("permissions", "roles", "uuid"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PermissionsWithUuidDTO>() {
           ...
           public PermissionsWithUuidDTO read(JsonReader in) throws IOException {
             ...
             PermissionsWithUuidDTO instance = thisAdapter.fromJsonTree(jsonObj);
