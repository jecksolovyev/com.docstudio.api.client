...
import com.docstudio.client.model.CommentMessageDTO;
...
public class CommentThreadDTO {
   ...
   * @return the CommentThreadDTO instance itself
   */
  public CommentThreadDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mailboxUuid, commentThreadDTO.mailboxUuid) &&
        ...
        Objects.equals(this.additionalProperties, commentThreadDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mailboxUuid, mailboxName, threadUuid, xpath, messages, accessType, sharedTo, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("mailboxUuid", "mailboxName", "threadUuid", "xpath", "messages", "accessType", "sharedTo"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CommentThreadDTO>() {
           ...
           public CommentThreadDTO read(JsonReader in) throws IOException {
             ...
             CommentThreadDTO instance = thisAdapter.fromJsonTree(jsonObj);
