...
public class SingleUuidDTO {
   ...
   * @return the SingleUuidDTO instance itself
   */
  public SingleUuidDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, singleUuidDTO.uuid)&&
        Objects.equals(this.additionalProperties, singleUuidDTO.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SingleUuidDTO>() {
           ...
           public SingleUuidDTO read(JsonReader in) throws IOException {
             ...
             SingleUuidDTO instance = thisAdapter.fromJsonTree(jsonObj);
