...
public class FullTemplateResponseDTO {
  ...
  public FullTemplateResponseDTO categories(List<UUID> categories) {
  ...
  public FullTemplateResponseDTO sharedCategories(List<UUID> sharedCategories) {
  ...
  public void setSharedCategories(List<UUID> sharedCategories) {
    this.sharedCategories = sharedCategories;
  }


  public FullTemplateResponseDTO sharedTo(Set<UUID> sharedTo) {
  ...
  public FullTemplateResponseDTO sharedToMailboxGroups(Set<UUID> sharedToMailboxGroups) {
