...
public class FullTemplateResponseDTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, data, version, dataCreatedAt, dataModifiedAt, access, mailbox, archive, newEnvelopeCanBeCreated, defaultDownloadOptions, categories, sharedCategories, sharedTo, sharedToMailboxGroups, logoImageUuid, createdAt, modifiedAt, additionalProperties);
  }
