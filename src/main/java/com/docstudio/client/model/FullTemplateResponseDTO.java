...
public class FullTemplateResponseDTO {
  ...
  private List<UUID> categories = null;

  @SerializedName("sharedCategories")
  private List<UUID> sharedCategories = null;
  ...
  **/
  ...
  public FullTemplateResponseDTO addCategoriesItem(UUID categoriesItem) {
    if (this.categories == null) {
      this.categories = new ArrayList<UUID>();
    }
  ...
  **/
  ...
  public FullTemplateResponseDTO addSharedCategoriesItem(UUID sharedCategoriesItem) {
    if (this.sharedCategories == null) {
      this.sharedCategories = new ArrayList<UUID>();
    }
  ...
  **/
  ...
  public FullTemplateResponseDTO sharedToMailboxGroups(List<UUID> sharedToMailboxGroups) {
  ...
  **/
  @Schema(description = "Mailbox groups to which template is shared to")
