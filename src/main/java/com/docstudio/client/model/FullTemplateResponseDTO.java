...
public class FullTemplateResponseDTO {
  ...
  public static final String SERIALIZED_NAME_PUBLICLY_SHARED = "publiclyShared";
  @SerializedName(SERIALIZED_NAME_PUBLICLY_SHARED)
  @javax.annotation.Nullable
  ...
  public FullTemplateResponseDTO signatureContainer(@javax.annotation.Nullable SignatureContainerEnum signatureContainer) {
  ...
  public FullTemplateResponseDTO publiclyShared(@javax.annotation.Nullable Boolean publiclyShared) {
    this.publiclyShared = publiclyShared;
    return this;
  }

  /**
   * Returns a flag indicating whether the template is publicly accessible by code
  ...
  public void setPubliclyShared(@javax.annotation.Nullable Boolean publiclyShared) {
    this.publiclyShared = publiclyShared;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, fullTemplateResponseDTO.uuid) &&
        ...
        Objects.equals(this.signatureContainer, fullTemplateResponseDTO.signatureContainer) &&
        ...
        Objects.equals(this.publiclyShared, fullTemplateResponseDTO.publiclyShared) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, data, version, dataCreatedAt, dataModifiedAt, signatureContainer, access, mailbox, account, archive, newEnvelopeCanBeCreated, publiclyShared, defaultDownloadOptions, categories, sharedCategories, sharedTo, sharedToMailboxGroups, logoImageUuid, createdAt, modifiedAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    publiclyShared: ").append(toIndentedString(publiclyShared)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "name", "description", "data", "version", "dataCreatedAt", "dataModifiedAt", "signatureContainer", "access", "mailbox", "account", "archive", "newEnvelopeCanBeCreated", "publiclyShared", "defaultDownloadOptions", "categories", "sharedCategories", "sharedTo", "sharedToMailboxGroups", "logoImageUuid", "createdAt", "modifiedAt"));
