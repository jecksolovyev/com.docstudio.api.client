...
public class FullTemplateResponseDTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, data, version, dataCreatedAt, dataModifiedAt, access, mailbox, account, archive, newEnvelopeCanBeCreated, publiclyShared, defaultDownloadOptions, categories, sharedCategories, sharedTo, sharedToMailboxGroups, logoImageUuid, createdAt, modifiedAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("publiclyShared");
