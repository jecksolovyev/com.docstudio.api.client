...
public class FullTemplateResponseDTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, data, version, dataCreatedAt, dataModifiedAt, access, mailbox, archive, newEnvelopeCanBeCreated, defaultDownloadOptions, categories, sharedCategories, sharedTo, sharedToMailboxGroups, logoImageUuid, createdAt, modifiedAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FullTemplateResponseDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FullTemplateResponseDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
