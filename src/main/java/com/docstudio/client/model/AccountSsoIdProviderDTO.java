...
public class AccountSsoIdProviderDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "firstNameMapping", "lastNameMapping", "phoneMapping", "metadataUrl", "metadataXml", "signingCertificate", "signingPrivateKey", "uuid", "createdAt"));
