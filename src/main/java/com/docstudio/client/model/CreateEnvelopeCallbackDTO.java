...
import com.docstudio.client.model.CallbackEnvelopeFilterDTO;
...
public class CreateEnvelopeCallbackDTO {
   ...
   * @return the CreateEnvelopeCallbackDTO instance itself
   */
  public CreateEnvelopeCallbackDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filter, createEnvelopeCallbackDTO.filter) &&
        ...
        Objects.equals(this.additionalProperties, createEnvelopeCallbackDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filter, url, retries, timeout, successCode, login, password, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("filter", "url", "retries", "timeout", "successCode", "login", "password"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("filter", "url", "retries", "timeout"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateEnvelopeCallbackDTO>() {
           ...
           public CreateEnvelopeCallbackDTO read(JsonReader in) throws IOException {
             ...
             CreateEnvelopeCallbackDTO instance = thisAdapter.fromJsonTree(jsonObj);
