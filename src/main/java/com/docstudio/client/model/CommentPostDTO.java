...
public class CommentPostDTO {
  ...
  public CommentPostDTO sharedTo(@javax.annotation.Nullable Set<Object> sharedTo) {
    this.sharedTo = sharedTo;
    return this;
  }

  public CommentPostDTO addSharedToItem(Object sharedToItem) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("documentId", "text", "xpath", "accessType", "sharedTo"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("documentId", "text", "accessType"));
  }
