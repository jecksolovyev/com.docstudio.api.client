...
public class UserNotificationResponseDTO {
  ...
  public UserNotificationResponseDTO data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
   ...
   * @return the UserNotificationResponseDTO instance itself
   */
  public UserNotificationResponseDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userNotificationResponseDTO.id) &&
        ...
        Objects.equals(this.additionalProperties, userNotificationResponseDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, code, data, createdAt, mailboxUuid, accountUuid, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "type", "code", "data", "createdAt", "mailboxUuid", "accountUuid"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "type", "code", "data", "createdAt"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserNotificationResponseDTO>() {
           ...
           public UserNotificationResponseDTO read(JsonReader in) throws IOException {
             ...
             UserNotificationResponseDTO instance = thisAdapter.fromJsonTree(jsonObj);
