...
public class AliasDTO {
  ...
  public AliasDTO name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the AliasDTO instance itself
   */
  public AliasDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, aliasDTO.name)&&
        Objects.equals(this.additionalProperties, aliasDTO.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AliasDTO>() {
           ...
           public AliasDTO read(JsonReader in) throws IOException {
             ...
             AliasDTO instance = thisAdapter.fromJsonTree(jsonObj);
