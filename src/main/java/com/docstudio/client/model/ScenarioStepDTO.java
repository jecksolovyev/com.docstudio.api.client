...
public class ScenarioStepDTO {
  ...
  /**
   * Scenario step source template info
   * @return source
   */
  @javax.annotation.Nullable
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "source", "destination", "xslt", "condition", "sendAfterCreation"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "name", "destination", "xslt"));
  }
