...
import com.docstudio.client.model.RequiredSignatureDTO;
...
public class DocumentForSigningDTO {
  ...
  public static final String SERIALIZED_NAME_STAMP_HASH = "stampHash";
  @SerializedName(SERIALIZED_NAME_STAMP_HASH)
  @javax.annotation.Nullable
  private byte[] stampHash;
  ...
  public DocumentForSigningDTO documentId(@javax.annotation.Nullable String documentId) {
  ...
  public DocumentForSigningDTO xmlName(@javax.annotation.Nullable String xmlName) {
  ...
  public void setXmlName(@javax.annotation.Nullable String xmlName) {
    this.xmlName = xmlName;
  }


  public DocumentForSigningDTO xml(@javax.annotation.Nullable String xml) {
    this.xml = xml;
    return this;
  }
  ...
  public DocumentForSigningDTO xmlHash(@javax.annotation.Nullable byte[] xmlHash) {
  ...
  public void setXmlHash(@javax.annotation.Nullable byte[] xmlHash) {
    this.xmlHash = xmlHash;
  }


  public DocumentForSigningDTO binaryFileName(@javax.annotation.Nullable String binaryFileName) {
  ...
  public void setBinaryFileName(@javax.annotation.Nullable String binaryFileName) {
    this.binaryFileName = binaryFileName;
  }


  public DocumentForSigningDTO binaryFile(@javax.annotation.Nullable byte[] binaryFile) {
  ...
  public void setBinaryFile(@javax.annotation.Nullable byte[] binaryFile) {
    this.binaryFile = binaryFile;
  }


  public DocumentForSigningDTO binaryHash(@javax.annotation.Nullable byte[] binaryHash) {
  ...
  public void setBinaryHash(@javax.annotation.Nullable byte[] binaryHash) {
    this.binaryHash = binaryHash;
  }


  public DocumentForSigningDTO stampHash(@javax.annotation.Nullable byte[] stampHash) {
    this.stampHash = stampHash;
    return this;
  }

  /**
   * Stamp hash for signing
   * @return stampHash
   */
  @javax.annotation.Nullable
  public byte[] getStampHash() {
    return stampHash;
  }

  public void setStampHash(@javax.annotation.Nullable byte[] stampHash) {
    this.stampHash = stampHash;
  }


  public DocumentForSigningDTO signatures(@javax.annotation.Nullable List<RequiredSignatureDTO> signatures) {
  ...
  public void setSignatures(@javax.annotation.Nullable List<RequiredSignatureDTO> signatures) {
    this.signatures = signatures;
  }
   ...
   * @return the DocumentForSigningDTO instance itself
   */
  public DocumentForSigningDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.documentId, documentForSigningDTO.documentId) &&
        ...
        Arrays.equals(this.stampHash, documentForSigningDTO.stampHash) &&
        Objects.equals(this.signatures, documentForSigningDTO.signatures)&&
        Objects.equals(this.additionalProperties, documentForSigningDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(documentId, xmlName, xml, Arrays.hashCode(xmlHash), binaryFileName, Arrays.hashCode(binaryFile), Arrays.hashCode(binaryHash), Arrays.hashCode(stampHash), signatures, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    stampHash: ").append(toIndentedString(stampHash)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("documentId", "xmlName", "xml", "xmlHash", "binaryFileName", "binaryFile", "binaryHash", "stampHash", "signatures"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DocumentForSigningDTO>() {
           ...
           public DocumentForSigningDTO read(JsonReader in) throws IOException {
             ...
             DocumentForSigningDTO instance = thisAdapter.fromJsonTree(jsonObj);
