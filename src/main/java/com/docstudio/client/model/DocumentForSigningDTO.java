...
public class DocumentForSigningDTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(documentId, xmlName, xml, Arrays.hashCode(xmlHash), binaryFileName, Arrays.hashCode(binaryFile), Arrays.hashCode(binaryHash), signatures, additionalProperties);
  }
