...
public class MailboxApprovalFlowDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sharedForAccount", "sharedForMailboxes", "name", "flowType", "approvers"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "flowType", "approvers"));
  }
