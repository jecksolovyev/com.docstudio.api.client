...
public class SearchEnvelopesDTO {
  ...
  @SerializedName("sendDateFrom")
  private OffsetDateTime sendDateFrom = null;

  @SerializedName("sendDateTo")
  private OffsetDateTime sendDateTo = null;
  ...
  **/
   ...
   * @return sendDateFrom
  **/
  @Schema(description = "Envelope sending date from")
   ...
   * @return sendDateTo
  **/
  @Schema(description = "Envelope sending date to")
