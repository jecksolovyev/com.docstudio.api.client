...
public class TemplateCreateDTO {
  ...
  public TemplateCreateDTO signatureContainer(@javax.annotation.Nullable SignatureContainerEnum signatureContainer) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, templateCreateDTO.data) &&
        ...
        Objects.equals(this.signatureContainer, templateCreateDTO.signatureContainer)&&
        Objects.equals(this.additionalProperties, templateCreateDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, access, categories, sharedTo, sharedToMailboxGroups, logoImageUuid, signatureContainer, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data", "access", "categories", "sharedTo", "sharedToMailboxGroups", "logoImageUuid", "signatureContainer"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("data", "access"));
  }
