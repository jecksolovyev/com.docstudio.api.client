...
public class DictionaryDownloadParamsDTO {
   ...
   * @return the DictionaryDownloadParamsDTO instance itself
   */
  public DictionaryDownloadParamsDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.format, dictionaryDownloadParamsDTO.format) &&
        ...
        Objects.equals(this.additionalProperties, dictionaryDownloadParamsDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(format, filters, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("format", "filters"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("format", "filters"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DictionaryDownloadParamsDTO>() {
           ...
           public DictionaryDownloadParamsDTO read(JsonReader in) throws IOException {
             ...
             DictionaryDownloadParamsDTO instance = thisAdapter.fromJsonTree(jsonObj);
