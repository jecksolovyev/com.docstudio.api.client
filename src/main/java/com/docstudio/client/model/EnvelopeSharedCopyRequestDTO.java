...
public class EnvelopeSharedCopyRequestDTO {
  ...
  public EnvelopeSharedCopyRequestDTO envelopeUuids(Set<UUID> envelopeUuids) {
  ...
  public EnvelopeSharedCopyRequestDTO mailboxUuids(Set<UUID> mailboxUuids) {
  ...
  public void setMailboxUuids(Set<UUID> mailboxUuids) {
    this.mailboxUuids = mailboxUuids;
  }
