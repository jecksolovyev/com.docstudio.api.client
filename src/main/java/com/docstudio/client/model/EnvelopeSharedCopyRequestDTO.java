...
public class EnvelopeSharedCopyRequestDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("envelopeUuids", "mailboxUuids"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("envelopeUuids", "mailboxUuids"));
  }
