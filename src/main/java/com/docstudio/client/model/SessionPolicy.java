...
public class SessionPolicy {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("sessionHours", "singleSession", "singleIpSession", "maxLoginAttempts", "maxAttemptsTimeoutMinutes", "allowedIps", "blockedIps"));
