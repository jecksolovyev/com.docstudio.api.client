...
public class ReportEnvelopeRequestDTO {
  ...
  private List<Object> uuids = new ArrayList<>();
  ...
  public ReportEnvelopeRequestDTO uuids(@javax.annotation.Nullable List<Object> uuids) {
    this.uuids = uuids;
    return this;
  }

  public ReportEnvelopeRequestDTO addUuidsItem(Object uuidsItem) {
    if (this.uuids == null) {
  ...
  public void setUuids(@javax.annotation.Nullable List<Object> uuids) {
    this.uuids = uuids;
  }
