...
public class SearchActivityLogDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accountUuid", "mailboxUuid", "action", "objectName", "objectType", "objectId", "operatorId", "source", "ip", "errorCode", "dateFrom", "dateTo"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("accountUuid"));
  }
