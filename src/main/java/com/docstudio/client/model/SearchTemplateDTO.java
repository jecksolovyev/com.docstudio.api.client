...
public class SearchTemplateDTO {
  ...
  public SearchTemplateDTO categories(List<UUID> categories) {
  ...
  public SearchTemplateDTO sharedCategories(List<UUID> sharedCategories) {
  ...
  public SearchTemplateDTO sharedTo(Set<UUID> sharedTo) {
  ...
  public SearchTemplateDTO sharedToMailboxGroups(Set<UUID> sharedToMailboxGroups) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, mailboxUuid, name, description, access, categories, sharedCategories, sharedTo, sharedToMailboxGroups, logoImageUuid, createdAt);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchTemplateDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchTemplateDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
