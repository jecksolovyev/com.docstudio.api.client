...
public class SearchTemplateDTO {
  ...
  public SearchTemplateDTO favorite(@javax.annotation.Nullable Boolean favorite) {
    this.favorite = favorite;
    return this;
  }

  /**
   * Template marked as favorite
   * @return favorite
   */
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, searchTemplateDTO.uuid) &&
        ...
        Objects.equals(this.favorite, searchTemplateDTO.favorite) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, mailboxUuid, name, description, access, categories, sharedCategories, sharedTo, sharedToMailboxGroups, logoImageUuid, favorite, createdAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "mailboxUuid", "name", "description", "access", "categories", "sharedCategories", "sharedTo", "sharedToMailboxGroups", "logoImageUuid", "favorite", "createdAt"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("uuid", "mailboxUuid", "name", "description"));
  }
