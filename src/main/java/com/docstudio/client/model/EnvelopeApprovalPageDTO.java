...
import com.docstudio.client.model.EnvApprovalSearchResultDTO;
...
public class EnvelopeApprovalPageDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("totalElements", "sizeRequested", "numberOfElements", "data", "initiators", "templates"));
