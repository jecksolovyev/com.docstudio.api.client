...
public class SsoProperties {
   ...
   * @return the SsoProperties instance itself
   */
  public SsoProperties putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, ssoProperties.enabled) &&
        ...
        Objects.equals(this.additionalProperties, ssoProperties.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, onlySsoLogin, saml, oauth, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("enabled", "onlySsoLogin", "saml", "oauth"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SsoProperties>() {
           ...
           public SsoProperties read(JsonReader in) throws IOException {
             ...
             SsoProperties instance = thisAdapter.fromJsonTree(jsonObj);
