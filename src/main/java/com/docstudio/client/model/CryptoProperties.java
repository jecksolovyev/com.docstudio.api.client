...
public class CryptoProperties {
  ...
  /**
   * Gets or Sets signatureContainers
   */
  @JsonAdapter(SignatureContainersEnum.Adapter.class)
  public enum SignatureContainersEnum {
    P7_S("P7S"),
    ...
    SignatureContainersEnum(String value) {
      this.value = value;
    }
    ...
    public static SignatureContainersEnum fromValue(String value) {
      for (SignatureContainersEnum b : SignatureContainersEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<SignatureContainersEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SignatureContainersEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SignatureContainersEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SignatureContainersEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      SignatureContainersEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_SIGNATURE_CONTAINERS = "signatureContainers";
  @SerializedName(SERIALIZED_NAME_SIGNATURE_CONTAINERS)
  @javax.annotation.Nullable
  private Set<SignatureContainersEnum> signatureContainers = new LinkedHashSet<>();

  /**
   * Gets or Sets defaultSignatureContainer
   */
  @JsonAdapter(DefaultSignatureContainerEnum.Adapter.class)
  public enum DefaultSignatureContainerEnum {
    P7_S("P7S"),
    ...
    DefaultSignatureContainerEnum(String value) {
      this.value = value;
    }
    ...
    public static DefaultSignatureContainerEnum fromValue(String value) {
      for (DefaultSignatureContainerEnum b : DefaultSignatureContainerEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<DefaultSignatureContainerEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final DefaultSignatureContainerEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public DefaultSignatureContainerEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return DefaultSignatureContainerEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      DefaultSignatureContainerEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_DEFAULT_SIGNATURE_CONTAINER = "defaultSignatureContainer";
  @SerializedName(SERIALIZED_NAME_DEFAULT_SIGNATURE_CONTAINER)
  @javax.annotation.Nullable
  private DefaultSignatureContainerEnum defaultSignatureContainer;

  public static final String SERIALIZED_NAME_ACCOUNT_DOCUMENT_SHARING_PROVIDERS = "accountDocumentSharingProviders";
  @SerializedName(SERIALIZED_NAME_ACCOUNT_DOCUMENT_SHARING_PROVIDERS)
  @javax.annotation.Nullable
  private List<String> accountDocumentSharingProviders = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_ALLOW_VERIFY_SIGNATURES = "allowVerifySignatures";
  @SerializedName(SERIALIZED_NAME_ALLOW_VERIFY_SIGNATURES)
  @javax.annotation.Nullable
  private Boolean allowVerifySignatures;
  ...
  public CryptoProperties signatureContainers(@javax.annotation.Nullable Set<SignatureContainersEnum> signatureContainers) {
    this.signatureContainers = signatureContainers;
    return this;
  }

  public CryptoProperties addSignatureContainersItem(SignatureContainersEnum signatureContainersItem) {
    if (this.signatureContainers == null) {
      this.signatureContainers = new LinkedHashSet<>();
    }
    this.signatureContainers.add(signatureContainersItem);
    return this;
  }

  /**
   * Get signatureContainers
   * @return signatureContainers
   */
  @javax.annotation.Nullable
  public Set<SignatureContainersEnum> getSignatureContainers() {
    return signatureContainers;
  }

  public void setSignatureContainers(@javax.annotation.Nullable Set<SignatureContainersEnum> signatureContainers) {
    this.signatureContainers = signatureContainers;
  }


  public CryptoProperties defaultSignatureContainer(@javax.annotation.Nullable DefaultSignatureContainerEnum defaultSignatureContainer) {
    this.defaultSignatureContainer = defaultSignatureContainer;
    return this;
  }

  /**
   * Get defaultSignatureContainer
   * @return defaultSignatureContainer
   */
  @javax.annotation.Nullable
  public DefaultSignatureContainerEnum getDefaultSignatureContainer() {
    return defaultSignatureContainer;
  }

  public void setDefaultSignatureContainer(@javax.annotation.Nullable DefaultSignatureContainerEnum defaultSignatureContainer) {
    this.defaultSignatureContainer = defaultSignatureContainer;
  }


  public CryptoProperties accountDocumentSharingProviders(@javax.annotation.Nullable List<String> accountDocumentSharingProviders) {
    this.accountDocumentSharingProviders = accountDocumentSharingProviders;
    return this;
  }

  public CryptoProperties addAccountDocumentSharingProvidersItem(String accountDocumentSharingProvidersItem) {
    if (this.accountDocumentSharingProviders == null) {
      this.accountDocumentSharingProviders = new ArrayList<>();
    }
    this.accountDocumentSharingProviders.add(accountDocumentSharingProvidersItem);
    return this;
  }

  /**
   * Get accountDocumentSharingProviders
   * @return accountDocumentSharingProviders
   */
  @javax.annotation.Nullable
  public List<String> getAccountDocumentSharingProviders() {
    return accountDocumentSharingProviders;
  }

  public void setAccountDocumentSharingProviders(@javax.annotation.Nullable List<String> accountDocumentSharingProviders) {
    this.accountDocumentSharingProviders = accountDocumentSharingProviders;
  }
  ...
  public CryptoProperties allowVerifySignatures(@javax.annotation.Nullable Boolean allowVerifySignatures) {
    this.allowVerifySignatures = allowVerifySignatures;
    return this;
  }

  /**
   * Get allowVerifySignatures
   * @return allowVerifySignatures
   */
  @javax.annotation.Nullable
  public Boolean getAllowVerifySignatures() {
    return allowVerifySignatures;
  }

  public void setAllowVerifySignatures(@javax.annotation.Nullable Boolean allowVerifySignatures) {
    this.allowVerifySignatures = allowVerifySignatures;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.region, cryptoProperties.region) &&
        Objects.equals(this.signatureProviders, cryptoProperties.signatureProviders) &&
        Objects.equals(this.signatureContainers, cryptoProperties.signatureContainers) &&
        Objects.equals(this.defaultSignatureContainer, cryptoProperties.defaultSignatureContainer) &&
        Objects.equals(this.accountDocumentSharingProviders, cryptoProperties.accountDocumentSharingProviders) &&
        ...
        Objects.equals(this.allowVerifySignatures, cryptoProperties.allowVerifySignatures)&&
        Objects.equals(this.additionalProperties, cryptoProperties.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(region, signatureProviders, signatureContainers, defaultSignatureContainer, accountDocumentSharingProviders, stampSupported, einkSupported, initialsSupported, edsSupported, padesSupported, ocspProxy, alwaysUseOcspProxy, allowVerifySignatures, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    signatureContainers: ").append(toIndentedString(signatureContainers)).append("\n");
    sb.append("    defaultSignatureContainer: ").append(toIndentedString(defaultSignatureContainer)).append("\n");
    sb.append("    accountDocumentSharingProviders: ").append(toIndentedString(accountDocumentSharingProviders)).append("\n");
    ...
    sb.append("    allowVerifySignatures: ").append(toIndentedString(allowVerifySignatures)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("region", "signatureProviders", "signatureContainers", "defaultSignatureContainer", "accountDocumentSharingProviders", "stampSupported", "einkSupported", "initialsSupported", "edsSupported", "padesSupported", "ocspProxy", "alwaysUseOcspProxy", "allowVerifySignatures"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("signatureContainers") != null && !jsonObj.get("signatureContainers").isJsonNull() && !jsonObj.get("signatureContainers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `signatureContainers` to be an array in the JSON string but got `%s`", jsonObj.get("signatureContainers").toString()));
      }
      if ((jsonObj.get("defaultSignatureContainer") != null && !jsonObj.get("defaultSignatureContainer").isJsonNull()) && !jsonObj.get("defaultSignatureContainer").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `defaultSignatureContainer` to be a primitive type in the JSON string but got `%s`", jsonObj.get("defaultSignatureContainer").toString()));
      }
      // validate the optional field `defaultSignatureContainer`
      if (jsonObj.get("defaultSignatureContainer") != null && !jsonObj.get("defaultSignatureContainer").isJsonNull()) {
        DefaultSignatureContainerEnum.validateJsonElement(jsonObj.get("defaultSignatureContainer"));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("accountDocumentSharingProviders") != null && !jsonObj.get("accountDocumentSharingProviders").isJsonNull() && !jsonObj.get("accountDocumentSharingProviders").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `accountDocumentSharingProviders` to be an array in the JSON string but got `%s`", jsonObj.get("accountDocumentSharingProviders").toString()));
      }
