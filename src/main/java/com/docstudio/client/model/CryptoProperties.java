...
public class CryptoProperties {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(region, signatureProviders, signatureContainer, accountDocumentSharingProviders, stampSupported, einkSupported, initialsSupported, edsSupported, padesSupported, ocspProxy, alwaysUseOcspProxy, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("accountDocumentSharingProviders");
