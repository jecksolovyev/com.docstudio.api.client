...
public class EnvelopeApprovalRequestDTO {
  ...
  public EnvelopeApprovalRequestDTO uuids(Set<UUID> uuids) {
    this.uuids = uuids;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnvelopeApprovalRequestDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnvelopeApprovalRequestDTO` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
