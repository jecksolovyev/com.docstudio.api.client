...
public class EnvelopeApprovalRequestDTO {
  ...
  public EnvelopeApprovalRequestDTO uuids(@javax.annotation.Nonnull Set<Object> uuids) {
    this.uuids = uuids;
    return this;
  }

  public EnvelopeApprovalRequestDTO addUuidsItem(Object uuidsItem) {
    if (this.uuids == null) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuids", "urgent", "flowUuid", "approvers"));
