...
public class CorporateProfileDTO {
  ...
  public CorporateProfileDTO fields(@javax.annotation.Nullable Map<String, Object> fields) {
    this.fields = fields;
    return this;
  }

  public CorporateProfileDTO putFieldsItem(String key, Object fieldsItem) {
    if (this.fields == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, corporateProfileDTO.uuid) &&
        ...
        Objects.equals(this.fields, corporateProfileDTO.fields)&&
        Objects.equals(this.additionalProperties, corporateProfileDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, email, firstName, lastName, status, dateLocale, locale, timezone, autoDepositMailboxUuid, phone, displayExactDate, mailboxes, fields, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "email", "firstName", "lastName", "status", "dateLocale", "locale", "timezone", "autoDepositMailboxUuid", "phone", "displayExactDate", "mailboxes", "fields"));
