...
public class DocumentsForSignRequestDTO {
  ...
  public DocumentsForSignRequestDTO stampCertificate(@javax.annotation.Nullable byte[] stampCertificate) {
   ...
   * @return the DocumentsForSignRequestDTO instance itself
   */
  public DocumentsForSignRequestDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Arrays.equals(this.signingCertificate, documentsForSignRequestDTO.signingCertificate) &&
        Arrays.equals(this.stampCertificate, documentsForSignRequestDTO.stampCertificate) &&
        ...
        Objects.equals(this.additionalProperties, documentsForSignRequestDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(Arrays.hashCode(signingCertificate), Arrays.hashCode(stampCertificate), skipBinaryFiles, documents, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("signingCertificate", "stampCertificate", "skipBinaryFiles", "documents"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DocumentsForSignRequestDTO>() {
           ...
           public DocumentsForSignRequestDTO read(JsonReader in) throws IOException {
             ...
             DocumentsForSignRequestDTO instance = thisAdapter.fromJsonTree(jsonObj);
