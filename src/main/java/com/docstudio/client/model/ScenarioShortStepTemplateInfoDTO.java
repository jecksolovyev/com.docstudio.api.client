...
public class ScenarioShortStepTemplateInfoDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("templateUuid", "templateVersionUuid", "templateName"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("templateUuid", "templateVersionUuid", "templateName"));
  }
