...
public class IntegrationRuleRequestDTO {
  ...
  public IntegrationRuleRequestDTO validationFiles(@javax.annotation.Nullable List<IntegrationRuleValidationFile> validationFiles) {
    this.validationFiles = validationFiles;
    return this;
  }

  public IntegrationRuleRequestDTO addValidationFilesItem(IntegrationRuleValidationFile validationFilesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mailboxUuid, integrationRuleRequestDTO.mailboxUuid) &&
        ...
        Objects.equals(this.validationFiles, integrationRuleRequestDTO.validationFiles)&&
        Objects.equals(this.additionalProperties, integrationRuleRequestDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mailboxUuid, templateUuid, versionUuid, in, namingRule, map, source, multipleEnvelopes, validationFiles, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("mailboxUuid", "templateUuid", "versionUuid", "in", "namingRule", "map", "source", "multipleEnvelopes", "validationFiles"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("mailboxUuid", "templateUuid", "versionUuid", "map", "source"));
  }
