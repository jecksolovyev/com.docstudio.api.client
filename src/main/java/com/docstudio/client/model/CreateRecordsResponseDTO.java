...
public class CreateRecordsResponseDTO {
  ...
  public CreateRecordsResponseDTO data(@javax.annotation.Nullable List<Object> data) {
    this.data = data;
    return this;
  }

  public CreateRecordsResponseDTO addDataItem(Object dataItem) {
    if (this.data == null) {
   ...
   * @return the CreateRecordsResponseDTO instance itself
   */
  public CreateRecordsResponseDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createRecordsResponseDTO.data) &&
        ...
        Objects.equals(this.additionalProperties, createRecordsResponseDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, totalElements, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data", "totalElements"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateRecordsResponseDTO>() {
           ...
           public CreateRecordsResponseDTO read(JsonReader in) throws IOException {
             ...
             CreateRecordsResponseDTO instance = thisAdapter.fromJsonTree(jsonObj);
