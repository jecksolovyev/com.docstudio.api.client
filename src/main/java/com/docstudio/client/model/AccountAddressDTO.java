...
public class AccountAddressDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("country", "region", "countryEn", "regionEn", "street", "street2", "city", "zip", "formattedAddress", "countryISO"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("country", "region", "countryEn", "regionEn", "street", "city", "zip", "formattedAddress"));
  }
