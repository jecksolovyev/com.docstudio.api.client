...
public class PasswordPolicy {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("minLength", "maxLength", "uppercase", "lowercase", "digit", "specialSymbol", "repeatCharacter", "allowWhitespace", "preventCommonPasswords", "preventCommonWords", "expirationDays", "notifyBeforeDays", "preventReuseMonths", "preventReuseCount"));
