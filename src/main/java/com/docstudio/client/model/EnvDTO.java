...
public class EnvDTO {
   ...
   * @return the EnvDTO instance itself
   */
  public EnvDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, envDTO.uuid) &&
        ...
        Objects.equals(this.additionalProperties, envDTO.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EnvDTO>() {
           ...
           public EnvDTO read(JsonReader in) throws IOException {
             ...
             EnvDTO instance = thisAdapter.fromJsonTree(jsonObj);
