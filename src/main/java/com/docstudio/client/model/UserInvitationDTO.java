...
public class UserInvitationDTO {
  ...
  public UserInvitationDTO documentSharingProviders(@javax.annotation.Nullable Set<String> documentSharingProviders) {
    this.documentSharingProviders = documentSharingProviders;
    return this;
  }

  public UserInvitationDTO addDocumentSharingProvidersItem(String documentSharingProvidersItem) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, system, allowMicrosoftOfficeViewer, company, permissions, mailboxes, documentSharingProviders, code, additionalProperties);
  }
