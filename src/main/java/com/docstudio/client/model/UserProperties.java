...
import com.docstudio.client.model.UserField;
...
public class UserProperties {
  public static final String SERIALIZED_NAME_PROFILE_PHONE_REQUIRED = "profilePhoneRequired";
  @SerializedName(SERIALIZED_NAME_PROFILE_PHONE_REQUIRED)
  @javax.annotation.Nullable
  private Boolean profilePhoneRequired;
  ...
  @javax.annotation.Nullable
  private List<UserField> profileFields = new ArrayList<>();

  public UserProperties() {
  }

  public UserProperties profilePhoneRequired(@javax.annotation.Nullable Boolean profilePhoneRequired) {
    this.profilePhoneRequired = profilePhoneRequired;
    return this;
  }

  /**
   * Get profilePhoneRequired
   * @return profilePhoneRequired
   */
  @javax.annotation.Nullable
  public Boolean getProfilePhoneRequired() {
    return profilePhoneRequired;
  }

  public void setProfilePhoneRequired(@javax.annotation.Nullable Boolean profilePhoneRequired) {
    this.profilePhoneRequired = profilePhoneRequired;
  }
  ...
  public UserProperties profileFields(@javax.annotation.Nullable List<UserField> profileFields) {
    this.profileFields = profileFields;
    return this;
  }

  public UserProperties addProfileFieldsItem(UserField profileFieldsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<UserField> getProfileFields() {
    return profileFields;
  }

  public void setProfileFields(@javax.annotation.Nullable List<UserField> profileFields) {
    this.profileFields = profileFields;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.profilePhoneRequired, userProperties.profilePhoneRequired) &&
        ...
        Objects.equals(this.profileFields, userProperties.profileFields)&&
        Objects.equals(this.additionalProperties, userProperties.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(profilePhoneRequired, passwordPolicy, sessionPolicy, measurementSystem, allowSelfDeletion, allowUserApplicationTokens, allowUsersToRegister, allowAutoDeposite, allowManageNotification, profileFields, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    profilePhoneRequired: ").append(toIndentedString(profilePhoneRequired)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("profilePhoneRequired", "passwordPolicy", "sessionPolicy", "measurementSystem", "allowSelfDeletion", "allowUserApplicationTokens", "allowUsersToRegister", "allowAutoDeposite", "allowManageNotification", "profileFields"));
      ...
      if (jsonObj.get("profileFields") != null && !jsonObj.get("profileFields").isJsonNull()) {
        ...
        if (jsonArrayprofileFields != null) {
          ...
          for (int i = 0; i < jsonArrayprofileFields.size(); i++) {
            UserField.validateJsonElement(jsonArrayprofileFields.get(i));
          };
        }
      }
  }
