...
public class DictionaryColumnValueSearchDTO {
   ...
   * @return the DictionaryColumnValueSearchDTO instance itself
   */
  public DictionaryColumnValueSearchDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.envelopeUuid, dictionaryColumnValueSearchDTO.envelopeUuid) &&
        ...
        Objects.equals(this.additionalProperties, dictionaryColumnValueSearchDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(envelopeUuid, templateUuid, versionUuid, documentId, fieldName, rowIndex, keyword, filter, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("envelopeUuid", "templateUuid", "versionUuid", "documentId", "fieldName", "rowIndex", "keyword", "filter"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DictionaryColumnValueSearchDTO>() {
           ...
           public DictionaryColumnValueSearchDTO read(JsonReader in) throws IOException {
             ...
             DictionaryColumnValueSearchDTO instance = thisAdapter.fromJsonTree(jsonObj);
