...
public class ContactDTO {
  ...
  public ContactDTO id(@javax.annotation.Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ContactDTO name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public ContactDTO mailboxUuid(@javax.annotation.Nonnull UUID mailboxUuid) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, mailboxUuid, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "name", "mailboxUuid"));
