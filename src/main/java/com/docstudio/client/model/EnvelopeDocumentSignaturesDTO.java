...
public class EnvelopeDocumentSignaturesDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("documentId", "signatureName", "signatures"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("documentId", "signatureName", "signatures"));
  }
