...
public class StampRequestDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("certificate", "envelopeUuid", "signingDate"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("certificate", "envelopeUuid"));
  }
