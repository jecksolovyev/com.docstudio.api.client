...
public class LoginResponseDTO {
   ...
   * @return the LoginResponseDTO instance itself
   */
  public LoginResponseDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, loginResponseDTO.token)&&
        Objects.equals(this.additionalProperties, loginResponseDTO.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LoginResponseDTO>() {
           ...
           public LoginResponseDTO read(JsonReader in) throws IOException {
             ...
             LoginResponseDTO instance = thisAdapter.fromJsonTree(jsonObj);
