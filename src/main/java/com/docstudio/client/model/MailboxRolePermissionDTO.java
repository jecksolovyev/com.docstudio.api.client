...
public class MailboxRolePermissionDTO {
   ...
   * @return the MailboxRolePermissionDTO instance itself
   */
  public MailboxRolePermissionDTO putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, mailboxRolePermissionDTO.uuid) &&
        ...
        Objects.equals(this.additionalProperties, mailboxRolePermissionDTO.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, permissions, system, invited, roles, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("uuid", "name", "permissions", "system", "invited", "roles"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MailboxRolePermissionDTO>() {
           ...
           public MailboxRolePermissionDTO read(JsonReader in) throws IOException {
             ...
             MailboxRolePermissionDTO instance = thisAdapter.fromJsonTree(jsonObj);
