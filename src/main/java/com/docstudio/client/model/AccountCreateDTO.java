...
public class AccountCreateDTO {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "inn", "mailboxes", "agreed"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "inn", "mailboxes", "agreed"));
  }
