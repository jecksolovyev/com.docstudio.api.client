...
public class ExchangeAs4DbnaProps {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("url", "dbnaAccount", "ftpPassword"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("url", "dbnaAccount", "ftpPassword"));
  }
