...
public class AppLinks {
  ...
  public static final String SERIALIZED_NAME_PUBLIC_ATTACHMENT = "publicAttachment";
  @SerializedName(SERIALIZED_NAME_PUBLIC_ATTACHMENT)
  @javax.annotation.Nullable
  private String publicAttachment;
  ...
  public AppLinks publicAttachment(@javax.annotation.Nullable String publicAttachment) {
    this.publicAttachment = publicAttachment;
    return this;
  }

  /**
   * Get publicAttachment
   * @return publicAttachment
   */
  @javax.annotation.Nullable
  public String getPublicAttachment() {
    return publicAttachment;
  }

  public void setPublicAttachment(@javax.annotation.Nullable String publicAttachment) {
    this.publicAttachment = publicAttachment;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.officialUrl, appLinks.officialUrl) &&
        ...
        Objects.equals(this.publicAttachment, appLinks.publicAttachment)&&
        Objects.equals(this.additionalProperties, appLinks.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(officialUrl, baseUrl, docsUrl, errorListUrl, termsAndConditions, privacyPolicy, altLoginPageSide, publicAttachment, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    publicAttachment: ").append(toIndentedString(publicAttachment)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("officialUrl", "baseUrl", "docsUrl", "errorListUrl", "termsAndConditions", "privacyPolicy", "altLoginPageSide", "publicAttachment"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("publicAttachment") != null && !jsonObj.get("publicAttachment").isJsonNull()) && !jsonObj.get("publicAttachment").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `publicAttachment` to be a primitive type in the JSON string but got `%s`", jsonObj.get("publicAttachment").toString()));
      }
  }
