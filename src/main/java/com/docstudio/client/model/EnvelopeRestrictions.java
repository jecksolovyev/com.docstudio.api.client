...
public class EnvelopeRestrictions {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("einkFooter", "field", "attachment", "search", "searchField", "table", "share", "listColumns", "listExtraColumn", "deleteFromBinAfterDays"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("listColumns") != null && !jsonObj.get("listColumns").isJsonNull()) {
        JsonArray jsonArraylistColumns = jsonObj.getAsJsonArray("listColumns");
        if (jsonArraylistColumns != null) {
          // ensure the json data is an array
          if (!jsonObj.get("listColumns").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `listColumns` to be an array in the JSON string but got `%s`", jsonObj.get("listColumns").toString()));
          }

          // validate the optional field `listColumns` (array)
          for (int i = 0; i < jsonArraylistColumns.size(); i++) {
            EnvelopeListColumn.validateJsonElement(jsonArraylistColumns.get(i));
          };
        }
      }
