...
import io.swagger.client.model.CreateRecordsResponseDTO;
import io.swagger.client.model.DictionaryCheckResponseDTO;
import io.swagger.client.model.DictionaryColumnRequestDTO;
import io.swagger.client.model.DictionaryColumnResponseDTO;
import io.swagger.client.model.DictionaryColumnValueRequestDTO;
import io.swagger.client.model.DictionaryColumnValueResponseDTO;
import io.swagger.client.model.DictionaryDownloadParamsDTO;
...
import io.swagger.client.model.DictionaryRequestDTO;
import io.swagger.client.model.DictionaryResponseDTO;
import io.swagger.client.model.ExportTaskStatusDTO;
import io.swagger.client.model.PageDTODictionaryColumnValueResponseDTO;
import io.swagger.client.model.PageDTODictionaryRecordValuesResponseDTO;
import io.swagger.client.model.PageDTODictionaryResponseDTO;
...
public class DictionaryControllerApi {
     ...
     * @param keyword Keyword to search by (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getColumnValuesCall(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit, String keyword, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getColumnValuesValidateBeforeCall(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit, String keyword, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'dictionaryUuid' is set
        if (dictionaryUuid == null) {
        ...
        com.squareup.okhttp.Call call = getColumnValuesCall(dictionaryUuid, columnUuid, mailbox, offset, limit, keyword, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageDTODictionaryColumnValueResponseDTO getColumnValues(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit, String keyword) throws ApiException {
        ApiResponse<PageDTODictionaryColumnValueResponseDTO> resp = getColumnValuesWithHttpInfo(dictionaryUuid, columnUuid, mailbox, offset, limit, keyword);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageDTODictionaryColumnValueResponseDTO> getColumnValuesWithHttpInfo(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit, String keyword) throws ApiException {
        com.squareup.okhttp.Call call = getColumnValuesValidateBeforeCall(dictionaryUuid, columnUuid, mailbox, offset, limit, keyword, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getColumnValuesAsync(UUID dictionaryUuid, UUID columnUuid, UUID mailbox, Integer offset, Integer limit, String keyword, final ApiCallback<PageDTODictionaryColumnValueResponseDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getColumnValuesValidateBeforeCall(dictionaryUuid, columnUuid, mailbox, offset, limit, keyword, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageDTODictionaryColumnValueResponseDTO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
