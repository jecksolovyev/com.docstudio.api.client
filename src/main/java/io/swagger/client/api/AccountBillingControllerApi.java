...
public class AccountBillingControllerApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void replaceAccountTariff(ReplaceAccountTariffDTO body, UUID accountUuid) throws ApiException {
        replaceAccountTariffWithHttpInfo(body, accountUuid);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> replaceAccountTariffWithHttpInfo(ReplaceAccountTariffDTO body, UUID accountUuid) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call replaceAccountTariffAsync(ReplaceAccountTariffDTO body, UUID accountUuid, final ApiCallback<Void> callback) throws ApiException {
