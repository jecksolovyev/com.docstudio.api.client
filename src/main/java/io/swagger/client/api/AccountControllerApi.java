...
import io.swagger.client.model.AccountAddressDTO;
import io.swagger.client.model.AccountCreateDTO;
import io.swagger.client.model.AccountDTO;
import io.swagger.client.model.AccountPoliciesDTO;
import io.swagger.client.model.CorporateUserCreateDTO;
import io.swagger.client.model.CryptoConfigDTO;
import java.io.File;
import io.swagger.client.model.MailboxAccountSimpleDTO;
import io.swagger.client.model.PageDTOAccountMailboxInfoDTO;
import io.swagger.client.model.PageDTOUserMailboxPermissionsDTO;
import io.swagger.client.model.ReportMailboxesRequestDTO;
import io.swagger.client.model.ReportUsersRequestDTO;
import io.swagger.client.model.SingleUuidDTO;
import java.util.UUID;
import io.swagger.client.model.User2AccountWithMailboxesDTO;
import io.swagger.client.model.UserDTO;
import io.swagger.client.model.UsersSearchFilterDTO;
...
public class AccountControllerApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void createMassAccountUsers(UUID accountUuid, File file) throws ApiException {
        createMassAccountUsersWithHttpInfo(accountUuid, file);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> createMassAccountUsersWithHttpInfo(UUID accountUuid, File file) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call createMassAccountUsersAsync(UUID accountUuid, File file, final ApiCallback<Void> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getCryptoConfigsCall(UUID accountUuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getCryptoConfigsValidateBeforeCall(UUID accountUuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'accountUuid' is set
        if (accountUuid == null) {
            throw new ApiException("Missing the required parameter 'accountUuid' when calling getCryptoConfigs(Async)");
        }
        
        com.squareup.okhttp.Call call = getCryptoConfigsCall(accountUuid, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<CryptoConfigDTO> getCryptoConfigs(UUID accountUuid) throws ApiException {
        ApiResponse<List<CryptoConfigDTO>> resp = getCryptoConfigsWithHttpInfo(accountUuid);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<CryptoConfigDTO>> getCryptoConfigsWithHttpInfo(UUID accountUuid) throws ApiException {
        com.squareup.okhttp.Call call = getCryptoConfigsValidateBeforeCall(accountUuid, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCryptoConfigsAsync(UUID accountUuid, final ApiCallback<List<CryptoConfigDTO>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCryptoConfigsValidateBeforeCall(accountUuid, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<CryptoConfigDTO>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call searchMailboxesAccountCall(UUID accountUuid, String keyword, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call searchMailboxesAccountValidateBeforeCall(UUID accountUuid, String keyword, Integer offset, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'accountUuid' is set
        if (accountUuid == null) {
            throw new ApiException("Missing the required parameter 'accountUuid' when calling searchMailboxesAccount(Async)");
        }
        
        com.squareup.okhttp.Call call = searchMailboxesAccountCall(accountUuid, keyword, offset, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageDTOAccountMailboxInfoDTO searchMailboxesAccount(UUID accountUuid, String keyword, Integer offset, Integer limit) throws ApiException {
        ApiResponse<PageDTOAccountMailboxInfoDTO> resp = searchMailboxesAccountWithHttpInfo(accountUuid, keyword, offset, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageDTOAccountMailboxInfoDTO> searchMailboxesAccountWithHttpInfo(UUID accountUuid, String keyword, Integer offset, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = searchMailboxesAccountValidateBeforeCall(accountUuid, keyword, offset, limit, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchMailboxesAccountAsync(UUID accountUuid, String keyword, Integer offset, Integer limit, final ApiCallback<PageDTOAccountMailboxInfoDTO> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = searchMailboxesAccountValidateBeforeCall(accountUuid, keyword, offset, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageDTOAccountMailboxInfoDTO>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateAccountDetailsCall(AccountDTO body, UUID uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateAccountDetailsValidateBeforeCall(AccountDTO body, UUID uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AccountDTO updateAccountDetails(AccountDTO body, UUID uuid) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AccountDTO> updateAccountDetailsWithHttpInfo(AccountDTO body, UUID uuid) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateAccountDetailsAsync(AccountDTO body, UUID uuid, final ApiCallback<AccountDTO> callback) throws ApiException {
