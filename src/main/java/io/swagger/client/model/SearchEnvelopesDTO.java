...
import io.swagger.client.model.SearchFieldValueDTO;
...
public class SearchEnvelopesDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(label, scope, status, subject, receiveDateFrom, receiveDateTo, expireDateFrom, expireDateTo, archived, template, activeRole, sender, recipient, sortField, sort, searchFields);
  }
