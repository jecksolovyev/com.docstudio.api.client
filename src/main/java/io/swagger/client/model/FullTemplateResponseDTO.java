...
public class FullTemplateResponseDTO {
  ...
  **/
   ...
   * @return archive
  **/
  @Schema(description = "Template archive")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, data, version, dataCreatedAt, dataModifiedAt, access, mailbox, archive, categories, sharedCategories, sharedTo, logoImageUuid, createdAt, modifiedAt);
  }
