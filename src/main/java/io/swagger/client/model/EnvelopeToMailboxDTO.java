...
import io.swagger.client.model.EnvelopeExtraFieldDTO;
...
public class EnvelopeToMailboxDTO {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(envelopeUuid, subject, message, archived, sentByMe, createdAt, seenAt, expiredAfter, sharingForbidden, status, accountUUID, mailboxUUID, mailboxName, total, completed, labels, templateUuid, templateName, invitationCode, chainUuid, chainedByMe, extraFields);
  }
