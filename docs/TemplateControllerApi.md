...
> List&lt;byte[]&gt; downloadTemplateImage(uuid, imageUuid, envelopeUuid, mailbox)
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID mailbox = UUID.randomUUID(); // UUID | Mailbox context, HTTP Header with current mailbox UUID
    try {
      List<byte[]> result = apiInstance.downloadTemplateImage(uuid, imageUuid, envelopeUuid, mailbox);
      System.out.println(result);
    } catch (ApiException e) {
...
# **downloadTemplatePdf**
> List&lt;byte[]&gt; downloadTemplatePdf(uuid, pdfUuid, envelopeUuid, clearFields, mailbox)
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID mailbox = UUID.randomUUID(); // UUID | Mailbox context, HTTP Header with current mailbox UUID
    try {
      List<byte[]> result = apiInstance.downloadTemplatePdf(uuid, pdfUuid, envelopeUuid, clearFields, mailbox);
      System.out.println(result);
    } catch (ApiException e) {
