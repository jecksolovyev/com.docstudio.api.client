...
DocStudio Api Documentation
  - API version: R82.8
  - Build date: 2023-06-19T23:56:47.469723923Z[GMT]
...
* `target/docstudio-api-client-R82.8.jar`
...
*ApplicationTokenControllerApi* | [**createTokenApplicationToken**](docs/ApplicationTokenControllerApi.md#createTokenApplicationToken) | **GET** /api/v1/token | List application tokens
...
*DictionaryControllerApi* | [**getColumnValues**](docs/DictionaryControllerApi.md#getColumnValues) | **GET** /api/v1/dictionary/{dictionaryUuid}/column/{columnUuid} | Retrieve column values from dictionary
...
*EnvelopeControllerApi* | [**shareEnvelopesByEmail**](docs/EnvelopeControllerApi.md#shareEnvelopesByEmail) | **POST** /api/v1/envelope/share | Share envelopes by email
...
*MailboxControllerApi* | [**getAccountLogo**](docs/MailboxControllerApi.md#getAccountLogo) | **GET** /api/v1/mailbox/logo/{mailboxUuid} | Retrieve mailbox account logo
